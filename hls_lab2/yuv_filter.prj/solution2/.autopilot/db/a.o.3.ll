; ModuleID = 'C:/Users/guill/Desktop/hls_lab2/yuv_filter.prj/solution2/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %tmp_28_cast = zext i23 %tmp_8 to i32, !dbg !252 ; [#uses=6 type=i32] [debug line = 94:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_28_cast, !dbg !252 ; [#uses=1 type=i8*] [debug line = 94:2]
...
.reset:                                           ; preds = %1
  ...
  %tmp_42_cast = zext i23 %tmp_20 to i32, !dbg !309 ; [#uses=6 type=i32] [debug line = 54:2]
  ...
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_42_cast, !dbg !313 ; [#uses=1 type=i8*] [debug line = 55:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_42_cast, !dbg !314 ; [#uses=1 type=i8*] [debug line = 56:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_42_cast, !dbg !315 ; [#uses=1 type=i8*] [debug line = 60:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_42_cast, !dbg !316 ; [#uses=1 type=i8*] [debug line = 61:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_42_cast, !dbg !317 ; [#uses=1 type=i8*] [debug line = 62:10]
...
!15 = metadata !{i32 786473, metadata !"yuv_filter.c", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
...
!21 = metadata !{i32 786473, metadata !"./image_aux.h", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
