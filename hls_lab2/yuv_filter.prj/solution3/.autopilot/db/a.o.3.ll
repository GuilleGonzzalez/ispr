; ModuleID = 'C:/Users/guill/Desktop/hls_lab2/yuv_filter.prj/solution3/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %tmp_15_cast = zext i23 %tmp_s to i32, !dbg !253 ; [#uses=3 type=i32] [debug line = 103:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_15_cast, !dbg !253 ; [#uses=1 type=i8*] [debug line = 103:10]
...
.reset:                                           ; preds = %0
  ...
  %tmp_26_cast = zext i23 %tmp_24 to i32, !dbg !310 ; [#uses=3 type=i32] [debug line = 54:2]
  ...
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_26_cast, !dbg !314 ; [#uses=1 type=i8*] [debug line = 55:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_26_cast, !dbg !315 ; [#uses=1 type=i8*] [debug line = 56:10]
...
!16 = metadata !{i32 786473, metadata !"yuv_filter.c", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 786473, metadata !"./image_aux.h", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
