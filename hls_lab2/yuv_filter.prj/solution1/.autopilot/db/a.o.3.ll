; ModuleID = 'C:/Users/guill/Desktop/hls_lab2/yuv_filter.prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %p_shl3_cast = call i23 @_ssdm_op_BitConcatenate.i23.i15.i8(i15 %tmp_1, i8 0), !dbg !201 ; [#uses=1 type=i23] [debug line = 141:10@24:4]
  %tmp_2 = add i23 %p_shl_cast, %p_shl3_cast, !dbg !201 ; [#uses=1 type=i23] [debug line = 141:10@24:4]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_5_i_cast = zext i16 %y_i to i23, !dbg !201 ; [#uses=1 type=i23] [debug line = 141:10@24:4]
  %tmp_3 = add i23 %tmp_2, %tmp_5_i_cast, !dbg !201 ; [#uses=1 type=i23] [debug line = 141:10@24:4]
  %tmp_3_cast = zext i23 %tmp_3 to i32, !dbg !201 ; [#uses=6 type=i32] [debug line = 141:10@24:4]
  %scale_channels_ch2_a = getelementptr [2457600 x i8]* %p_scale_channels_ch2, i32 0, i32 %tmp_3_cast, !dbg !201 ; [#uses=1 type=i8*] [debug line = 141:10@24:4]
  %yuv_channels_ch3_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch3, i32 0, i32 %tmp_3_cast, !dbg !206 ; [#uses=1 type=i8*] [debug line = 136:10@24:4]
  ...
  %yuv_channels_ch1_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch1, i32 0, i32 %tmp_3_cast, !dbg !208 ; [#uses=1 type=i8*] [debug line = 134:2@24:4]
  %scale_channels_ch1_a = getelementptr [2457600 x i8]* %p_scale_channels_ch1, i32 0, i32 %tmp_3_cast, !dbg !209 ; [#uses=1 type=i8*] [debug line = 140:10@24:4]
  ...
  %Y = load i8* %yuv_channels_ch1_add, align 1, !dbg !208 ; [#uses=1 type=i8] [debug line = 134:2@24:4]
  call void @llvm.dbg.value(metadata !{i8 %Y}, i64 0, metadata !211), !dbg !208 ; [debug line = 134:2@24:4] [debug variable = Y]
  ...
  %V = load i8* %yuv_channels_ch3_add, align 1, !dbg !206 ; [#uses=1 type=i8] [debug line = 136:10@24:4]
  call void @llvm.dbg.value(metadata !{i8 %V}, i64 0, metadata !213), !dbg !206 ; [debug line = 136:10@24:4] [debug variable = V]
  ...
  %tmp_10_i = call i8 @_ssdm_op_PartSelect.i8.i15.i32.i32(i15 %tmp_7_i, i32 7, i32 14), !dbg !209 ; [#uses=1 type=i8] [debug line = 140:10@24:4]
  store i8 %tmp_10_i, i8* %scale_channels_ch1_a, align 1, !dbg !209 ; [debug line = 140:10@24:4]
  %tmp_11_i = call i8 @_ssdm_op_PartSelect.i8.i15.i32.i32(i15 %tmp_i, i32 7, i32 14), !dbg !201 ; [#uses=1 type=i8] [debug line = 141:10@24:4]
  store i8 %tmp_11_i, i8* %scale_channels_ch2_a, align 1, !dbg !201 ; [debug line = 141:10@24:4]
...
!74 = metadata !{i32 786473, metadata !"yuv_filter.c", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
...
!80 = metadata !{i32 786473, metadata !"./image_aux.h", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab2", null} ; [ DW_TAG_file_type ]
...
!201 = metadata !{i32 141, i32 10, metadata !192, metadata !105}
...
!206 = metadata !{i32 136, i32 10, metadata !192, metadata !105}
!207 = metadata !{i32 142, i32 10, metadata !192, metadata !105}
!208 = metadata !{i32 134, i32 2, metadata !192, metadata !105}
!209 = metadata !{i32 140, i32 10, metadata !192, metadata !105}
