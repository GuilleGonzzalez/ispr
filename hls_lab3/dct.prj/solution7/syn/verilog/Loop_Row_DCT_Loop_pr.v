...
reg   [7:0] tmp_16_cast_reg_510;
reg   [2:0] buf_2d_in_addr_reg_515;
...
reg   [7:0] tmp_4_reg_529;
reg   [7:0] ap_reg_pp0_iter1_tmp_4_reg_529;
reg   [7:0] ap_reg_pp0_iter2_tmp_4_reg_529;
reg   [7:0] ap_reg_pp0_iter3_tmp_4_reg_529;
reg   [7:0] ap_reg_pp0_iter4_tmp_4_reg_529;
wire   [15:0] tmp_49_fu_222_p1;
reg  signed [15:0] tmp_49_reg_539;
wire   [15:0] tmp_50_fu_226_p1;
reg  signed [15:0] tmp_50_reg_544;
...
reg  signed [28:0] tmp6_reg_634;
reg    ap_enable_reg_pp0_iter2;
wire  signed [28:0] grp_fu_479_p3;
reg  signed [28:0] tmp2_reg_639;
reg    ap_enable_reg_pp0_iter3;
wire  signed [28:0] grp_fu_486_p3;
reg  signed [28:0] tmp3_reg_644;
(* use_dsp48 = "no" *) wire   [28:0] tmp4_fu_418_p2;
reg   [28:0] tmp4_reg_649;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state3))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'd0))) begin
        buf_2d_in_addr_reg_515 <= i_2_i1_cast_i_fu_179_p1;
        tmp_16_cast_reg_510[6 : 3] <= tmp_16_cast_fu_192_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == tmp_i_reg_520))) begin
        tmp_10_i_reg_564 <= {{buf_2d_in_q0[47:32]}};
        tmp_11_i_reg_569 <= {{dct_coeff_table_q0[63:48]}};
        tmp_12_i_reg_574 <= {{buf_2d_in_q0[63:48]}};
        tmp_13_i_reg_579 <= {{dct_coeff_table_q0[79:64]}};
        tmp_14_i_reg_584 <= {{buf_2d_in_q0[79:64]}};
        tmp_15_i_reg_589 <= {{dct_coeff_table_q0[95:80]}};
        tmp_16_i_reg_594 <= {{buf_2d_in_q0[95:80]}};
        tmp_17_i_reg_599 <= {{dct_coeff_table_q0[111:96]}};
        tmp_18_i_reg_604 <= {{buf_2d_in_q0[111:96]}};
        tmp_1_reg_609 <= {{dct_coeff_table_q0[126:112]}};
        tmp_20_i_reg_614 <= {{buf_2d_in_q0[127:112]}};
        tmp_49_reg_539 <= tmp_49_fu_222_p1;
        tmp_50_reg_544 <= tmp_50_fu_226_p1;
        tmp_6_i_reg_549 <= {{dct_coeff_table_q0[31:16]}};
        tmp_7_i_reg_554 <= {{buf_2d_in_q0[31:16]}};
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign buf_2d_in_address0 = buf_2d_in_addr_reg_515;
...
assign i_fu_173_p2 = (i_0_i_reg_145 + 4'd1);
...
assign row_outbuf_i_address0 = tmp_17_cast_fu_441_p1;

assign row_outbuf_i_d0 = tmp_1_i_reg_654;

assign tmp1_fu_422_p2 = ($signed(tmp3_reg_644) + $signed(tmp2_reg_639));

assign tmp4_fu_418_p2 = ($signed(tmp6_reg_634) + $signed(grp_fu_493_p3));

assign tmp_16_cast_fu_192_p1 = tmp_s_fu_184_p3;

assign tmp_17_cast_fu_441_p1 = ap_reg_pp0_iter4_tmp_4_reg_529;

assign tmp_49_fu_222_p1 = dct_coeff_table_q0[15:0];

assign tmp_4_fu_217_p2 = (k_cast1_i_cast_fu_213_p1 + tmp_16_cast_reg_510);

assign tmp_50_fu_226_p1 = buf_2d_in_q0[15:0];

assign tmp_9_i_fu_426_p2 = (tmp4_reg_649 + tmp1_fu_422_p2);

assign tmp_fu_167_p2 = ((i_0_i_reg_145 == 4'd8) ? 1'b1 : 1'b0);

assign tmp_i_fu_196_p2 = ((k_i_reg_156 == 4'd8) ? 1'b1 : 1'b0);

assign tmp_s_fu_184_p3 = {{i_0_i_reg_145}, {3'd0}};

always @ (posedge ap_clk) begin
    tmp_16_cast_reg_510[2:0] <= 3'b000;
    tmp_16_cast_reg_510[7] <= 1'b0;
end
