; ModuleID = 'C:/Users/guill/Desktop/hls_lab3/dct.prj/solution5/.autopilot/db/a.o.3.bc'
...
.preheader2.preheader:                            ; preds = %ifBlock, %.preheader2.preheader.preheader
  ...
  %j = phi i4 [ %j_cast_mid2_v, %ifBlock ], [ 0, %.preheader2.preheader.preheader ] ; [#uses=2 type=i4]
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_7), !dbg !130 ; [#uses=0 type=i32] [debug line = 40:34]
...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %tmp_4 = icmp eq i4 %i_1, -8, !dbg !138         ; [#uses=2 type=i1] [debug line = 39:11]
  %i_1_mid2 = select i1 %tmp_4, i4 0, i4 %i_1     ; [#uses=3 type=i4]
  %j_cast_mid2_v = select i1 %tmp_4, i4 %j_2, i4 %j, !dbg !139 ; [#uses=3 type=i4] [debug line = 37:9]
  %j_cast_mid2 = zext i4 %j_cast_mid2_v to i32, !dbg !139 ; [#uses=8 type=i32] [debug line = 37:9]
  ...
  %tmp_6_cast = zext i7 %tmp_5 to i8, !dbg !140   ; [#uses=1 type=i8] [debug line = 40:1]
  %tmp_8 = add i8 %tmp_6_cast, %j_cast_mid2_cast, !dbg !140 ; [#uses=1 type=i8] [debug line = 40:1]
  %tmp_8_cast = zext i8 %tmp_8 to i32, !dbg !140  ; [#uses=1 type=i32] [debug line = 40:1]
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_8_cast, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str6) nounwind, !dbg !141 ; [debug line = 40:2]
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str6), !dbg !141 ; [#uses=1 type=i32] [debug line = 40:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !142 ; [debug line = 41:1]
  %row_outbuf_load = load i16* %row_outbuf_addr, align 2, !dbg !140 ; [#uses=8 type=i16] [debug line = 40:1]
  %tmp_6 = trunc i4 %i_1_mid2 to i3               ; [#uses=1 type=i3]
  switch i3 %tmp_6, label %branch7 [
    ...
    i3 -3, label %branch5
    i3 -2, label %branch6
  ], !dbg !140                                    ; [debug line = 40:1]

.preheader1:                                      ; preds = %3, %.preheader1.preheader
  %i_2 = phi i4 [ %i_5, %3 ], [ 0, %.preheader1.preheader ] ; [#uses=4 type=i4]
  %tmp_9 = icmp eq i4 %i_2, -8, !dbg !128         ; [#uses=1 type=i1] [debug line = 43:9]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %i_5 = add i4 %i_2, 1, !dbg !143                ; [#uses=1 type=i4] [debug line = 43:61]
  br i1 %tmp_9, label %.preheader.preheader.preheader, label %3, !dbg !128 ; [debug line = 43:9]

.preheader.preheader.preheader:                   ; preds = %.preheader1
  br label %.preheader.preheader

; <label>:3                                       ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str7) nounwind, !dbg !144 ; [debug line = 43:67]
  call fastcc void @dct_1d([8 x i16]* %col_inbuf_0, [8 x i16]* %col_inbuf_1, [8 x i16]* %col_inbuf_2, [8 x i16]* %col_inbuf_3, [8 x i16]* %col_inbuf_4, [8 x i16]* %col_inbuf_5, [8 x i16]* %col_inbuf_6, [8 x i16]* %col_inbuf_7, i4 %i_2, [64 x i16]* %col_outbuf, i4 %i_2), !dbg !146 ; [debug line = 44:7]
  call void @llvm.dbg.value(metadata !{i4 %i_5}, i64 0, metadata !126), !dbg !143 ; [debug line = 43:61] [debug variable = i]
...
.preheader:                                       ; preds = %.preheader.preheader
  %j_3 = add i4 %j_1, 1, !dbg !147                ; [#uses=1 type=i4] [debug line = 48:61]
  call void @llvm.dbg.value(metadata !{i4 %j_3}, i64 0, metadata !137), !dbg !147 ; [debug line = 48:61] [debug variable = j]
  ...
  %tmp_s = icmp eq i4 %i_3, -8, !dbg !149         ; [#uses=2 type=i1] [debug line = 50:11]
  %i_3_mid2 = select i1 %tmp_s, i4 0, i4 %i_3     ; [#uses=3 type=i4]
  %j_1_cast9_mid2_v = select i1 %tmp_s, i4 %j_3, i4 %j_1, !dbg !152 ; [#uses=3 type=i4] [debug line = 48:9]
  %j_1_cast9_mid2_cast = zext i4 %j_1_cast9_mid2_v to i8 ; [#uses=1 type=i8]
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_cast9_mid2_v, i3 0) ; [#uses=1 type=i7]
  %tmp_11_cast = zext i7 %tmp_1 to i8, !dbg !149  ; [#uses=1 type=i8] [debug line = 50:11]
  %i_3_cast8_cast = zext i4 %i_3_mid2 to i8, !dbg !153 ; [#uses=1 type=i8] [debug line = 51:1]
  %tmp_2 = add i8 %i_3_cast8_cast, %tmp_11_cast, !dbg !153 ; [#uses=1 type=i8] [debug line = 51:1]
  %tmp_12_cast = zext i8 %tmp_2 to i32, !dbg !153 ; [#uses=1 type=i32] [debug line = 51:1]
  %out_block_addr = getelementptr [64 x i16]* %out_block, i32 0, i32 %tmp_12_cast, !dbg !153 ; [#uses=1 type=i16*] [debug line = 51:1]
  %tmp_10 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_mid2, i3 0) ; [#uses=1 type=i7]
  %tmp_14_cast = zext i7 %tmp_10 to i8, !dbg !153 ; [#uses=1 type=i8] [debug line = 51:1]
  %tmp_11 = add i8 %j_1_cast9_mid2_cast, %tmp_14_cast, !dbg !153 ; [#uses=1 type=i8] [debug line = 51:1]
  %tmp_15_cast = zext i8 %tmp_11 to i32, !dbg !153 ; [#uses=1 type=i32] [debug line = 51:1]
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i32 0, i32 %tmp_15_cast, !dbg !153 ; [#uses=1 type=i16*] [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str9) nounwind, !dbg !155 ; [debug line = 51:2]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9), !dbg !155 ; [#uses=1 type=i32] [debug line = 51:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !156 ; [debug line = 52:1]
  %col_outbuf_load = load i16* %col_outbuf_addr, align 2, !dbg !153 ; [#uses=1 type=i16] [debug line = 51:1]
  store i16 %col_outbuf_load, i16* %out_block_addr, align 2, !dbg !153 ; [debug line = 51:1]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_3), !dbg !157 ; [#uses=0 type=i32] [debug line = 51:34]
  %i_7 = add i4 %i_3_mid2, 1, !dbg !158           ; [#uses=1 type=i4] [debug line = 50:63]
  call void @llvm.dbg.value(metadata !{i4 %i_7}, i64 0, metadata !126), !dbg !158 ; [debug line = 50:63] [debug variable = i]
  br label %.preheader.preheader
...
branch0:                                          ; preds = %.preheader2
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_0_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch1:                                          ; preds = %.preheader2
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_1_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch2:                                          ; preds = %.preheader2
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_2_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch3:                                          ; preds = %.preheader2
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_3_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch4:                                          ; preds = %.preheader2
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_4_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch5:                                          ; preds = %.preheader2
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_5_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch6:                                          ; preds = %.preheader2
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_6_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]

branch7:                                          ; preds = %.preheader2
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i32 0, i32 %j_cast_mid2, !dbg !140 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf_load, i16* %col_inbuf_7_addr, align 2, !dbg !140 ; [debug line = 40:1]
  br label %ifBlock, !dbg !140                    ; [debug line = 40:1]
}
...
define internal fastcc void @dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %i_2, [64 x i16]* nocapture %dst, i4 %i_21) {
  ...
  %tmp_17_cast = zext i7 %tmp_12 to i8            ; [#uses=1 type=i8]
  %i_2_cast = zext i4 %i_2_read to i32            ; [#uses=8 type=i32]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %dst}, i64 0, metadata !160), !dbg !166 ; [debug line = 4:81] [debug variable = dst]
  ...
  br label %1, !dbg !167                          ; [debug line = 13:9]

; <label>:1                                       ; preds = %2, %0
  %k = phi i4 [ 0, %0 ], [ %k_1, %2 ]             ; [#uses=4 type=i4]
  %tmp = icmp eq i4 %k, -8, !dbg !167             ; [#uses=1 type=i1] [debug line = 13:9]
  %k_1 = add i4 %k, 1, !dbg !170                  ; [#uses=1 type=i4] [debug line = 13:61]
  br i1 %tmp, label %3, label %2, !dbg !167       ; [debug line = 13:9]

; <label>:2                                       ; preds = %1
  %k_cast1 = zext i4 %k to i32, !dbg !167         ; [#uses=8 type=i32] [debug line = 13:9]
  %k_cast1_cast = zext i4 %k to i8, !dbg !171     ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_13 = add i8 %tmp_17_cast, %k_cast1_cast, !dbg !171 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_18_cast = zext i8 %tmp_13 to i32, !dbg !171 ; [#uses=1 type=i32] [debug line = 19:7]
  %dst_addr = getelementptr [64 x i16]* %dst, i32 0, i32 %tmp_18_cast, !dbg !171 ; [#uses=1 type=i16*] [debug line = 19:7]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind, !dbg !173 ; [debug line = 13:67]
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind, !dbg !173 ; [#uses=1 type=i32] [debug line = 13:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !174 ; [debug line = 14:1]
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i14*] [debug line = 16:48]
  %dct_coeff_table_0_lo = load i14* %dct_coeff_table_0_ad, align 2, !dbg !175 ; [#uses=1 type=i14] [debug line = 16:48]
  %coeff_cast = zext i14 %dct_coeff_table_0_lo to i29 ; [#uses=1 type=i29]
  %src_load = load i16* %src_addr, align 2        ; [#uses=1 type=i16]
  %tmp_6_cast = sext i16 %src_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7 = mul i29 %coeff_cast, %tmp_6_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_1_lo = load i15* %dct_coeff_table_1_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_1_cast = sext i15 %dct_coeff_table_1_lo to i29 ; [#uses=1 type=i29]
  %src1_load = load i16* %src1_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_1_cast = sext i16 %src1_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_1 = mul i29 %coeff_1_cast, %tmp_6_1_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_2_lo = load i15* %dct_coeff_table_2_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_2_cast = sext i15 %dct_coeff_table_2_lo to i29 ; [#uses=1 type=i29]
  %src2_load = load i16* %src2_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_2_cast = sext i16 %src2_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_2 = mul i29 %coeff_2_cast, %tmp_6_2_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_3_lo = load i15* %dct_coeff_table_3_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_3_cast = sext i15 %dct_coeff_table_3_lo to i29 ; [#uses=1 type=i29]
  %src3_load = load i16* %src3_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_3_cast = sext i16 %src3_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_3 = mul i29 %coeff_3_cast, %tmp_6_3_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_4_lo = load i15* %dct_coeff_table_4_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_4_cast = sext i15 %dct_coeff_table_4_lo to i29 ; [#uses=1 type=i29]
  %src4_load = load i16* %src4_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_4_cast = sext i16 %src4_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_4 = mul i29 %coeff_4_cast, %tmp_6_4_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_5_lo = load i15* %dct_coeff_table_5_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_5_cast = sext i15 %dct_coeff_table_5_lo to i29 ; [#uses=1 type=i29]
  %src5_load = load i16* %src5_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_5_cast = sext i16 %src5_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_5 = mul i29 %coeff_5_cast, %tmp_6_5_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_6_lo = load i15* %dct_coeff_table_6_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_6_cast = sext i15 %dct_coeff_table_6_lo to i29 ; [#uses=1 type=i29]
  %src6_load = load i16* %src6_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_6_cast = sext i16 %src6_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_6 = mul i29 %coeff_6_cast, %tmp_6_6_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_cast1, !dbg !175 ; [#uses=1 type=i15*] [debug line = 16:48]
  %dct_coeff_table_7_lo = load i15* %dct_coeff_table_7_ad, align 2, !dbg !175 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_7_cast = sext i15 %dct_coeff_table_7_lo to i29 ; [#uses=1 type=i29]
  %src7_load = load i16* %src7_addr, align 2      ; [#uses=1 type=i16]
  %tmp_6_7_cast = sext i16 %src7_load to i29, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_7 = mul i29 %coeff_7_cast, %tmp_6_7_cast, !dbg !178 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp2 = add i29 %tmp_7_1, %tmp_7, !dbg !171     ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp3 = add i29 %tmp_7_3, %tmp_7_2, !dbg !171   ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !171         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp5 = add i29 %tmp_7_5, %tmp_7_4, !dbg !171   ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp7 = add i29 %tmp_7_7, 4096, !dbg !171       ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp6 = add i29 %tmp_7_6, %tmp7, !dbg !171      ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !171         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_3 = add i29 %tmp1, %tmp4, !dbg !171        ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_5 = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_3, i32 13, i32 28), !dbg !171 ; [#uses=1 type=i16] [debug line = 19:7]
  store i16 %tmp_5, i16* %dst_addr, align 2, !dbg !171 ; [debug line = 19:7]
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_s) nounwind, !dbg !179 ; [#uses=0 type=i32] [debug line = 20:4]
  call void @llvm.dbg.value(metadata !{i4 %k_1}, i64 0, metadata !180), !dbg !170 ; [debug line = 13:61] [debug variable = k]
...
define void @dct([64 x i16]* %input, [64 x i16]* %output) nounwind {
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @p_str1) nounwind, !dbg !182 ; [debug line = 80:1]
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i16]* %input) nounwind, !map !187
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i16]* %output) nounwind, !map !193
  ...
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !197), !dbg !198 ; [debug line = 78:16] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !199), !dbg !200 ; [debug line = 78:38] [debug variable = output]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_0}, metadata !201), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_1}, metadata !204), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[1]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_2}, metadata !205), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[2]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_3}, metadata !206), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[3]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_4}, metadata !207), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[4]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_5}, metadata !208), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[5]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_6}, metadata !209), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[6]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %buf_2d_in_7}, metadata !210), !dbg !203 ; [debug line = 81:10] [debug variable = buf_2d_in[7]]
  call void @llvm.dbg.declare(metadata !{[64 x i16]* %buf_2d_out}, metadata !211), !dbg !212 ; [debug line = 82:10] [debug variable = buf_2d_out]
  call fastcc void @read_data([64 x i16]* %input, [8 x i16]* %buf_2d_in_0, [8 x i16]* %buf_2d_in_1, [8 x i16]* %buf_2d_in_2, [8 x i16]* %buf_2d_in_3, [8 x i16]* %buf_2d_in_4, [8 x i16]* %buf_2d_in_5, [8 x i16]* %buf_2d_in_6, [8 x i16]* %buf_2d_in_7) nounwind, !dbg !213 ; [debug line = 85:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in_0, [8 x i16]* %buf_2d_in_1, [8 x i16]* %buf_2d_in_2, [8 x i16]* %buf_2d_in_3, [8 x i16]* %buf_2d_in_4, [8 x i16]* %buf_2d_in_5, [8 x i16]* %buf_2d_in_6, [8 x i16]* %buf_2d_in_7, [64 x i16]* %buf_2d_out) nounwind, !dbg !214 ; [debug line = 87:4]
  call fastcc void @write_data([64 x i16]* %buf_2d_out, [64 x i16]* %output) nounwind, !dbg !215 ; [debug line = 90:4]
  ret void, !dbg !216                             ; [debug line = 91:1]
}
...
!139 = metadata !{i32 37, i32 9, metadata !134, null}
!140 = metadata !{i32 40, i32 1, metadata !131, null}
!141 = metadata !{i32 40, i32 2, metadata !131, null}
!142 = metadata !{i32 41, i32 1, metadata !131, null}
!143 = metadata !{i32 43, i32 61, metadata !129, null}
!144 = metadata !{i32 43, i32 67, metadata !145, null}
!145 = metadata !{i32 786443, metadata !129, i32 43, i32 66, metadata !21, i32 13} ; [ DW_TAG_lexical_block ]
!146 = metadata !{i32 44, i32 7, metadata !145, null}
!147 = metadata !{i32 48, i32 61, metadata !148, null}
!148 = metadata !{i32 786443, metadata !111, i32 48, i32 4, metadata !21, i32 14} ; [ DW_TAG_lexical_block ]
!149 = metadata !{i32 50, i32 11, metadata !150, null}
!150 = metadata !{i32 786443, metadata !151, i32 50, i32 7, metadata !21, i32 16} ; [ DW_TAG_lexical_block ]
!151 = metadata !{i32 786443, metadata !148, i32 49, i32 1, metadata !21, i32 15} ; [ DW_TAG_lexical_block ]
!152 = metadata !{i32 48, i32 9, metadata !148, null}
!153 = metadata !{i32 51, i32 1, metadata !154, null}
!154 = metadata !{i32 786443, metadata !150, i32 51, i32 1, metadata !21, i32 17} ; [ DW_TAG_lexical_block ]
!155 = metadata !{i32 51, i32 2, metadata !154, null}
!156 = metadata !{i32 52, i32 1, metadata !154, null}
!157 = metadata !{i32 51, i32 34, metadata !154, null}
!158 = metadata !{i32 50, i32 63, metadata !150, null}
!159 = metadata !{i32 52, i32 1, metadata !111, null}
!160 = metadata !{i32 786689, metadata !161, metadata !"dst", null, i32 4, metadata !165, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!161 = metadata !{i32 786478, i32 0, metadata !21, metadata !"dct_1d", metadata !"dct_1d", metadata !"", metadata !21, i32 4, metadata !162, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !30, i32 5} ; [ DW_TAG_subprogram ]
!162 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !163, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!163 = metadata !{null, metadata !164, metadata !164}
!164 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !96} ; [ DW_TAG_pointer_type ]
!165 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !96, metadata !27, i32 0, i32 0} ; [ DW_TAG_array_type ]
!166 = metadata !{i32 4, i32 81, metadata !161, null}
!167 = metadata !{i32 13, i32 9, metadata !168, null}
!168 = metadata !{i32 786443, metadata !169, i32 13, i32 4, metadata !21, i32 1} ; [ DW_TAG_lexical_block ]
!169 = metadata !{i32 786443, metadata !161, i32 5, i32 1, metadata !21, i32 0} ; [ DW_TAG_lexical_block ]
!170 = metadata !{i32 13, i32 61, metadata !168, null}
!171 = metadata !{i32 19, i32 7, metadata !172, null}
!172 = metadata !{i32 786443, metadata !168, i32 13, i32 66, metadata !21, i32 2} ; [ DW_TAG_lexical_block ]
!173 = metadata !{i32 13, i32 67, metadata !172, null}
!174 = metadata !{i32 14, i32 1, metadata !172, null}
!175 = metadata !{i32 16, i32 48, metadata !176, null}
!176 = metadata !{i32 786443, metadata !177, i32 15, i32 77, metadata !21, i32 4} ; [ DW_TAG_lexical_block ]
!177 = metadata !{i32 786443, metadata !172, i32 15, i32 7, metadata !21, i32 3} ; [ DW_TAG_lexical_block ]
!178 = metadata !{i32 17, i32 10, metadata !176, null}
!179 = metadata !{i32 20, i32 4, metadata !172, null}
!180 = metadata !{i32 786688, metadata !169, metadata !"k", metadata !21, i32 6, metadata !127, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!181 = metadata !{i32 21, i32 1, metadata !169, null}
!182 = metadata !{i32 80, i32 1, metadata !183, null}
!183 = metadata !{i32 786443, metadata !184, i32 79, i32 1, metadata !21, i32 28} ; [ DW_TAG_lexical_block ]
!184 = metadata !{i32 786478, i32 0, metadata !21, metadata !"dct", metadata !"dct", metadata !"", metadata !21, i32 78, metadata !185, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !30, i32 79} ; [ DW_TAG_subprogram ]
!185 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !186, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!186 = metadata !{null, metadata !29, metadata !29}
!187 = metadata !{metadata !188}
!188 = metadata !{i32 0, i32 15, metadata !189}
!189 = metadata !{metadata !190}
!190 = metadata !{metadata !"input", metadata !191, metadata !"short", i32 0, i32 15}
!191 = metadata !{metadata !192}
!192 = metadata !{i32 0, i32 63, i32 1}
!193 = metadata !{metadata !194}
!194 = metadata !{i32 0, i32 15, metadata !195}
!195 = metadata !{metadata !196}
!196 = metadata !{metadata !"output", metadata !191, metadata !"short", i32 0, i32 15}
!197 = metadata !{i32 786689, metadata !184, metadata !"input", null, i32 78, metadata !36, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!198 = metadata !{i32 78, i32 16, metadata !184, null}
!199 = metadata !{i32 786689, metadata !184, metadata !"output", null, i32 78, metadata !36, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!200 = metadata !{i32 78, i32 38, metadata !184, null}
!201 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[0]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!202 = metadata !{i32 786688, metadata !183, metadata !"buf_2d_in", metadata !21, i32 81, metadata !32, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!203 = metadata !{i32 81, i32 10, metadata !183, null}
!204 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[1]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!205 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[2]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!206 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[3]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!207 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[4]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!208 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[5]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!209 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[6]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!210 = metadata !{i32 790529, metadata !202, metadata !"buf_2d_in[7]", null, i32 81, metadata !64, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!211 = metadata !{i32 786688, metadata !183, metadata !"buf_2d_out", metadata !21, i32 82, metadata !32, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!212 = metadata !{i32 82, i32 10, metadata !183, null}
!213 = metadata !{i32 85, i32 4, metadata !183, null}
!214 = metadata !{i32 87, i32 4, metadata !183, null}
!215 = metadata !{i32 90, i32 4, metadata !183, null}
!216 = metadata !{i32 91, i32 1, metadata !183, null}
