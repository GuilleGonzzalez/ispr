; ModuleID = 'C:/Users/guill/Desktop/hls_lab3/dct.prj/solution5/.autopilot/db/a.o.bc'
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_SpecArrayPartition to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !224 ; [debug line = 82:1]
