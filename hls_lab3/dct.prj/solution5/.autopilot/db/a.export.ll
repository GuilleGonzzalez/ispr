...
.preheader2.preheader:                            ; preds = %.preheader2.preheader.preheader, %ifBlock
  ...
  %j = phi i4 [ %j_cast_mid2_v, %ifBlock ], [ 0, %.preheader2.preheader.preheader ]
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_7)
...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %tmp_4 = icmp eq i4 %i_1, -8
  %i_1_mid2 = select i1 %tmp_4, i4 0, i4 %i_1
  %j_cast_mid2_v = select i1 %tmp_4, i4 %j_2, i4 %j
  %j_cast_mid2 = zext i4 %j_cast_mid2_v to i32
  ...
  %tmp_8 = add i8 %tmp_6_cast, %j_cast_mid2_cast
  ...
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str6)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %row_outbuf_load = load i16* %row_outbuf_addr, align 2
  %tmp_6 = trunc i4 %i_1_mid2 to i3
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_s = icmp eq i4 %i_3, -8
  %i_3_mid2 = select i1 %tmp_s, i4 0, i4 %i_3
  %j_1_cast9_mid2_v = select i1 %tmp_s, i4 %j_3, i4 %j_1
  %j_1_cast9_mid2_cast = zext i4 %j_1_cast9_mid2_v to i8
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_cast9_mid2_v, i3 0)
  %tmp_11_cast = zext i7 %tmp_1 to i8
  %i_3_cast8_cast = zext i4 %i_3_mid2 to i8
  %tmp_2 = add i8 %i_3_cast8_cast, %tmp_11_cast
  %tmp_12_cast = zext i8 %tmp_2 to i32
  %out_block_addr = getelementptr [64 x i16]* %out_block, i32 0, i32 %tmp_12_cast
  %tmp_10 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_mid2, i3 0)
  %tmp_14_cast = zext i7 %tmp_10 to i8
  %tmp_11 = add i8 %j_1_cast9_mid2_cast, %tmp_14_cast
  %tmp_15_cast = zext i8 %tmp_11 to i32
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i32 0, i32 %tmp_15_cast
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str9) nounwind
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %col_outbuf_load = load i16* %col_outbuf_addr, align 2
  store i16 %col_outbuf_load, i16* %out_block_addr, align 2
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_3)
...
branch0:                                          ; preds = %.preheader2
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_0_addr, align 2
  br label %ifBlock

branch1:                                          ; preds = %.preheader2
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_1_addr, align 2
  br label %ifBlock

branch2:                                          ; preds = %.preheader2
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_2_addr, align 2
  br label %ifBlock

branch3:                                          ; preds = %.preheader2
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_3_addr, align 2
  br label %ifBlock

branch4:                                          ; preds = %.preheader2
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_4_addr, align 2
  br label %ifBlock

branch5:                                          ; preds = %.preheader2
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_5_addr, align 2
  br label %ifBlock

branch6:                                          ; preds = %.preheader2
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i32 0, i32 %j_cast_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_6_addr, align 2
  br label %ifBlock

branch7:                                          ; preds = %.preheader2
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i32 0, i32 %j_cast_mid2
...
define internal fastcc void @dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %i_2, [64 x i16]* nocapture %dst, i4 %i_21) {
  ...
  %tmp_12 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_21_read, i3 0)
  %tmp_17_cast = zext i7 %tmp_12 to i8
  %i_2_cast = zext i4 %i_2_read to i32
  %src_addr = getelementptr [8 x i16]* %src, i32 0, i32 %i_2_cast
  %src1_addr = getelementptr [8 x i16]* %src1, i32 0, i32 %i_2_cast
  %src2_addr = getelementptr [8 x i16]* %src2, i32 0, i32 %i_2_cast
  %src3_addr = getelementptr [8 x i16]* %src3, i32 0, i32 %i_2_cast
  %src4_addr = getelementptr [8 x i16]* %src4, i32 0, i32 %i_2_cast
  %src5_addr = getelementptr [8 x i16]* %src5, i32 0, i32 %i_2_cast
  %src6_addr = getelementptr [8 x i16]* %src6, i32 0, i32 %i_2_cast
  %src7_addr = getelementptr [8 x i16]* %src7, i32 0, i32 %i_2_cast
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_13 = add i8 %tmp_17_cast, %k_cast1_cast
  %tmp_18_cast = zext i8 %tmp_13 to i32
  %dst_addr = getelementptr [64 x i16]* %dst, i32 0, i32 %tmp_18_cast
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8)
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i32 0, i32 %k_cast1
  ...
  %tmp_7 = mul i29 %coeff_cast, %tmp_6_cast
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_cast1
  ...
  %tmp_6_1_cast = sext i16 %src1_load to i29
  %tmp_7_1 = mul i29 %coeff_1_cast, %tmp_6_1_cast
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_cast1
  ...
  %tmp_6_2_cast = sext i16 %src2_load to i29
  %tmp_7_2 = mul i29 %coeff_2_cast, %tmp_6_2_cast
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_cast1
  ...
  %tmp_6_3_cast = sext i16 %src3_load to i29
  %tmp_7_3 = mul i29 %coeff_3_cast, %tmp_6_3_cast
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_cast1
  ...
  %tmp_6_4_cast = sext i16 %src4_load to i29
  %tmp_7_4 = mul i29 %coeff_4_cast, %tmp_6_4_cast
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_cast1
  ...
  %tmp_6_5_cast = sext i16 %src5_load to i29
  %tmp_7_5 = mul i29 %coeff_5_cast, %tmp_6_5_cast
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_cast1
  ...
  %tmp_6_6_cast = sext i16 %src6_load to i29
  %tmp_7_6 = mul i29 %coeff_6_cast, %tmp_6_6_cast
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_cast1
  ...
  %tmp_6_7_cast = sext i16 %src7_load to i29
  %tmp_7_7 = mul i29 %coeff_7_cast, %tmp_6_7_cast
