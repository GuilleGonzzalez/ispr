; ModuleID = 'C:/Users/guill/Desktop/hls_lab3/dct.prj/solution6/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_2), !dbg !53 ; [#uses=0 type=i32] [debug line = 74:67]
...
; <label>:1                                       ; preds = %ifBlock, %0
  ...
  %r = phi i4 [ 0, %0 ], [ %r_cast_mid2_v, %ifBlock ] ; [#uses=2 type=i4]
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str11, i32 %tmp_4), !dbg !76 ; [#uses=0 type=i32] [debug line = 62:66]
...
.reset:                                           ; preds = %1
  ...
  %r_cast_mid2_v = select i1 %exitcond, i4 %r_2, i4 %r, !dbg !73 ; [#uses=3 type=i4] [debug line = 59:9]
  %r_cast_mid2 = zext i4 %r_cast_mid2_v to i32, !dbg !73 ; [#uses=8 type=i32] [debug line = 59:9]
  %tmp = trunc i4 %r_cast_mid2_v to i3            ; [#uses=1 type=i3]
  ...
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str11), !dbg !86 ; [#uses=1 type=i32] [debug line = 62:2]
...
branch0:                                          ; preds = %.reset
  %buf_0_addr = getelementptr [8 x i16]* %buf_0, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_0_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch1:                                          ; preds = %.reset
  %buf_1_addr = getelementptr [8 x i16]* %buf_1, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_1_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch2:                                          ; preds = %.reset
  %buf_2_addr = getelementptr [8 x i16]* %buf_2, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_2_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch3:                                          ; preds = %.reset
  %buf_3_addr = getelementptr [8 x i16]* %buf_3, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_3_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch4:                                          ; preds = %.reset
  %buf_4_addr = getelementptr [8 x i16]* %buf_4, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_4_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch5:                                          ; preds = %.reset
  %buf_5_addr = getelementptr [8 x i16]* %buf_5, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_5_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch6:                                          ; preds = %.reset
  %buf_6_addr = getelementptr [8 x i16]* %buf_6, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %input_load, i16* %buf_6_addr, align 2, !dbg !85 ; [debug line = 62:1]
  br label %ifBlock, !dbg !85                     ; [debug line = 62:1]

branch7:                                          ; preds = %.reset
  %buf_7_addr = getelementptr [8 x i16]* %buf_7, i32 0, i32 %r_cast_mid2, !dbg !85 ; [#uses=1 type=i16*] [debug line = 62:1]
...
.preheader2.i:                                    ; preds = %0
  ...
  %j_0_i_cast_mid2_v = select i1 %tmp_s, i4 %j, i4 %j_0_i, !dbg !150 ; [#uses=3 type=i4] [debug line = 37:9@87:4]
  %j_0_i_cast_mid2 = zext i4 %j_0_i_cast_mid2_v to i32, !dbg !150 ; [#uses=8 type=i32] [debug line = 37:9@87:4]
  %j_0_i_cast_mid2_cast = zext i4 %j_0_i_cast_mid2_v to i8 ; [#uses=1 type=i8]
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1_i_mid2, i3 0) ; [#uses=1 type=i7]
  %tmp_5_cast = zext i7 %tmp to i8, !dbg !151     ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  %tmp_7 = add i8 %tmp_5_cast, %j_0_i_cast_mid2_cast, !dbg !151 ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  %tmp_7_cast = zext i8 %tmp_7 to i32, !dbg !151  ; [#uses=1 type=i32] [debug line = 40:1@87:4]
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_7_cast, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str6) nounwind, !dbg !153 ; [debug line = 40:2@87:4]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str6) nounwind, !dbg !153 ; [#uses=1 type=i32] [debug line = 40:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !154 ; [debug line = 41:1@87:4]
  %row_outbuf_i_load = load i16* %row_outbuf_i_addr, align 2, !dbg !151 ; [#uses=8 type=i16] [debug line = 40:1@87:4]
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_2) nounwind, !dbg !155 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
  %i = add i4 %i_1_i_mid2, 1, !dbg !156           ; [#uses=1 type=i4] [debug line = 39:63@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !157) nounwind, !dbg !156 ; [debug line = 39:63@87:4] [debug variable = i]
  br label %0

branch0:                                          ; preds = %.preheader2.i
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_0_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch1:                                          ; preds = %.preheader2.i
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_1_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch2:                                          ; preds = %.preheader2.i
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_2_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch3:                                          ; preds = %.preheader2.i
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_3_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch4:                                          ; preds = %.preheader2.i
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_4_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch5:                                          ; preds = %.preheader2.i
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_5_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch6:                                          ; preds = %.preheader2.i
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_6_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]

branch7:                                          ; preds = %.preheader2.i
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i32 0, i32 %j_0_i_cast_mid2, !dbg !151 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf_i_load, i16* %col_inbuf_7_addr, align 2, !dbg !151 ; [debug line = 40:1@87:4]
  br label %ifBlock, !dbg !151                    ; [debug line = 40:1@87:4]
}
...
.preheader.i:                                     ; preds = %0
  %j = add i4 %j_1_i, 1, !dbg !158                ; [#uses=1 type=i4] [debug line = 48:61@87:4]
  call void @llvm.dbg.value(metadata !{i4 %j}, i64 0, metadata !145) nounwind, !dbg !158 ; [debug line = 48:61@87:4] [debug variable = j]
  call void (...)* @_ssdm_op_SpecLoopName([42 x i8]* @Xpose_Col_Outer_Loop)
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) nounwind ; [#uses=0 type=i32]
  %tmp_s = icmp eq i4 %i_3_i, -8, !dbg !160       ; [#uses=2 type=i1] [debug line = 50:11@87:4]
  %i_3_i_mid2 = select i1 %tmp_s, i4 0, i4 %i_3_i ; [#uses=3 type=i4]
  %j_1_i_cast_mid2_v = select i1 %tmp_s, i4 %j, i4 %j_1_i, !dbg !163 ; [#uses=3 type=i4] [debug line = 48:9@87:4]
  %j_1_i_cast_mid2_cast = zext i4 %j_1_i_cast_mid2_v to i8 ; [#uses=1 type=i8]
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_i_cast_mid2_v, i3 0) ; [#uses=1 type=i7]
  %tmp_9_cast = zext i7 %tmp to i8, !dbg !160     ; [#uses=1 type=i8] [debug line = 50:11@87:4]
  %i_3_i_cast_cast = zext i4 %i_3_i_mid2 to i8    ; [#uses=1 type=i8]
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_i_mid2, i3 0) ; [#uses=1 type=i7]
  %tmp_11_cast = zext i7 %tmp_1 to i8, !dbg !164  ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_2 = add i8 %j_1_i_cast_mid2_cast, %tmp_11_cast, !dbg !164 ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_12_cast = zext i8 %tmp_2 to i32, !dbg !164 ; [#uses=1 type=i32] [debug line = 51:1@87:4]
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_12_cast, !dbg !164 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  %tmp_4 = add i8 %i_3_i_cast_cast, %tmp_9_cast, !dbg !164 ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_13_cast = zext i8 %tmp_4 to i32, !dbg !164 ; [#uses=1 type=i32] [debug line = 51:1@87:4]
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_13_cast, !dbg !164 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str9) nounwind, !dbg !166 ; [debug line = 51:2@87:4]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9) nounwind, !dbg !166 ; [#uses=1 type=i32] [debug line = 51:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !167 ; [debug line = 52:1@87:4]
  %col_outbuf_i_load = load i16* %col_outbuf_i_addr, align 2, !dbg !164 ; [#uses=1 type=i16] [debug line = 51:1@87:4]
  store i16 %col_outbuf_i_load, i16* %buf_2d_out_addr, align 2, !dbg !164 ; [debug line = 51:1@87:4]
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_3) nounwind, !dbg !168 ; [#uses=0 type=i32] [debug line = 51:34@87:4]
  %i = add i4 %i_3_i_mid2, 1, !dbg !169           ; [#uses=1 type=i4] [debug line = 50:63@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !157) nounwind, !dbg !169 ; [debug line = 50:63@87:4] [debug variable = i]
  br label %0

; <label>:0                                       ; preds = %.preheader.i, %newFuncRoot
  %indvar_flatten = phi i7 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader.i ] ; [#uses=2 type=i7]
  %j_1_i = phi i4 [ 0, %newFuncRoot ], [ %j_1_i_cast_mid2_v, %.preheader.i ] ; [#uses=2 type=i4]
...
newFuncRoot:
  br label %dct_1d.exit, !dbg !170                ; [debug line = 32:8@87:4]
...
dct_1d.exit:                                      ; preds = %dct_1d.exit.loopexit, %newFuncRoot
  ...
  %tmp = icmp eq i4 %i_0_i, -8, !dbg !170         ; [#uses=1 type=i1] [debug line = 32:8@87:4]
  %i = add i4 %i_0_i, 1, !dbg !172                ; [#uses=1 type=i4] [debug line = 32:60@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !157) nounwind, !dbg !172 ; [debug line = 32:60@87:4] [debug variable = i]
  br i1 %tmp, label %.preheader2.i.exitStub, label %0, !dbg !170 ; [debug line = 32:8@87:4]

; <label>:0                                       ; preds = %dct_1d.exit
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str4) nounwind, !dbg !173 ; [debug line = 32:66@87:4]
  %i_2_i1_cast_i = zext i4 %i_0_i to i32          ; [#uses=8 type=i32]
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_0_i, i3 0) ; [#uses=1 type=i7]
  %tmp_15_cast = zext i7 %tmp_s to i8, !dbg !175  ; [#uses=1 type=i8] [debug line = 4:81@33:7@87:4]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %row_outbuf_i}, i64 0, metadata !181) nounwind, !dbg !175 ; [debug line = 4:81@33:7@87:4] [debug variable = dst]
  %buf_2d_in_0_addr = getelementptr [8 x i16]* %buf_2d_in_0, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_1_addr = getelementptr [8 x i16]* %buf_2d_in_1, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_2_addr = getelementptr [8 x i16]* %buf_2d_in_2, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_3_addr = getelementptr [8 x i16]* %buf_2d_in_3, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_4_addr = getelementptr [8 x i16]* %buf_2d_in_4, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_5_addr = getelementptr [8 x i16]* %buf_2d_in_5, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_6_addr = getelementptr [8 x i16]* %buf_2d_in_6, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %buf_2d_in_7_addr = getelementptr [8 x i16]* %buf_2d_in_7, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  br label %1, !dbg !183                          ; [debug line = 13:9@33:7@87:4]

; <label>:1                                       ; preds = %2, %0
  %k_i = phi i4 [ 0, %0 ], [ %k, %2 ]             ; [#uses=4 type=i4]
  %tmp_i = icmp eq i4 %k_i, -8, !dbg !183         ; [#uses=1 type=i1] [debug line = 13:9@33:7@87:4]
  %k = add i4 %k_i, 1, !dbg !186                  ; [#uses=1 type=i4] [debug line = 13:61@33:7@87:4]
  br i1 %tmp_i, label %dct_1d.exit.loopexit, label %2, !dbg !183 ; [debug line = 13:9@33:7@87:4]

; <label>:2                                       ; preds = %1
  %k_cast1_i = zext i4 %k_i to i32, !dbg !183     ; [#uses=8 type=i32] [debug line = 13:9@33:7@87:4]
  %k_cast1_i_cast = zext i4 %k_i to i8, !dbg !187 ; [#uses=1 type=i8] [debug line = 19:7@33:7@87:4]
  %tmp_5 = add i8 %tmp_15_cast, %k_cast1_i_cast, !dbg !187 ; [#uses=1 type=i8] [debug line = 19:7@33:7@87:4]
  %tmp_16_cast = zext i8 %tmp_5 to i32, !dbg !187 ; [#uses=1 type=i32] [debug line = 19:7@33:7@87:4]
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_16_cast, !dbg !187 ; [#uses=1 type=i16*] [debug line = 19:7@33:7@87:4]
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind, !dbg !189 ; [debug line = 13:67@33:7@87:4]
  %tmp_5_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind, !dbg !189 ; [#uses=1 type=i32] [debug line = 13:67@33:7@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !190 ; [debug line = 14:1@33:7@87:4]
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i14*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_0_lo = load i14* %dct_coeff_table_0_ad, align 2, !dbg !191 ; [#uses=1 type=i14] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_cast_i = sext i16 %buf_2d_in_0_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_1_lo = load i15* %dct_coeff_table_1_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_1_cast_i = sext i16 %buf_2d_in_1_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_2_lo = load i15* %dct_coeff_table_2_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_2_cast_i = sext i16 %buf_2d_in_2_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_3_lo = load i15* %dct_coeff_table_3_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_3_cast_i = sext i16 %buf_2d_in_3_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_4_lo = load i15* %dct_coeff_table_4_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_4_cast_i = sext i16 %buf_2d_in_4_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_5_lo = load i15* %dct_coeff_table_5_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_5_cast_i = sext i16 %buf_2d_in_5_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_6_lo = load i15* %dct_coeff_table_6_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_6_cast_i = sext i16 %buf_2d_in_6_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_6_i = mul i29 %coeff_6_cast_i, %tmp_2_6_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_cast1_i, !dbg !191 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  %dct_coeff_table_7_lo = load i15* %dct_coeff_table_7_ad, align 2, !dbg !191 ; [#uses=1 type=i15] [debug line = 16:48@33:7@87:4]
  ...
  %tmp_2_7_cast_i = sext i16 %buf_2d_in_7_load to i29, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp_3_7_i = mul i29 %coeff_7_cast_i, %tmp_2_7_cast_i, !dbg !194 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp2 = add i29 %tmp_3_1_i, %tmp_3_i, !dbg !187 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp3 = add i29 %tmp_3_3_i, %tmp_3_2_i, !dbg !187 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !187         ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp5 = add i29 %tmp_3_5_i, %tmp_3_4_i, !dbg !187 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp7 = add i29 %tmp_3_7_i, 4096, !dbg !187     ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp6 = add i29 %tmp_3_6_i, %tmp7, !dbg !187    ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !187         ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp_9_i = add i29 %tmp1, %tmp4, !dbg !187      ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp_1_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_9_i, i32 13, i32 28), !dbg !187 ; [#uses=1 type=i16] [debug line = 19:7@33:7@87:4]
  store i16 %tmp_1_i, i16* %row_outbuf_i_addr, align 2, !dbg !187 ; [debug line = 19:7@33:7@87:4]
  %empty_17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_5_i) nounwind, !dbg !195 ; [#uses=0 type=i32] [debug line = 20:4@33:7@87:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !196) nounwind, !dbg !186 ; [debug line = 13:61@33:7@87:4] [debug variable = k]
  br label %1, !dbg !186                          ; [debug line = 13:61@33:7@87:4]
}
...
.preheader1.i:                                    ; preds = %.preheader1.i.loopexit, %newFuncRoot
  ...
  %tmp_5 = icmp eq i4 %i_2_i, -8, !dbg !197       ; [#uses=1 type=i1] [debug line = 43:9@87:4]
  %i = add i4 %i_2_i, 1, !dbg !199                ; [#uses=1 type=i4] [debug line = 43:61@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !157) nounwind, !dbg !199 ; [debug line = 43:61@87:4] [debug variable = i]
  br i1 %tmp_5, label %.preheader.i.exitStub, label %0, !dbg !197 ; [debug line = 43:9@87:4]

; <label>:0                                       ; preds = %.preheader1.i
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str7) nounwind, !dbg !200 ; [debug line = 43:67@87:4]
  %i_2_i1_cast_i = zext i4 %i_2_i to i32          ; [#uses=8 type=i32]
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_2_i, i3 0) ; [#uses=1 type=i7]
  %tmp_18_cast = zext i7 %tmp_s to i8, !dbg !202  ; [#uses=1 type=i8] [debug line = 4:81@44:7@87:4]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %col_outbuf_i}, i64 0, metadata !204) nounwind, !dbg !202 ; [debug line = 4:81@44:7@87:4] [debug variable = dst]
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i32 0, i32 %i_2_i1_cast_i ; [#uses=1 type=i16*]
  br label %1, !dbg !205                          ; [debug line = 13:9@44:7@87:4]

; <label>:1                                       ; preds = %2, %0
  %k_i = phi i4 [ 0, %0 ], [ %k, %2 ]             ; [#uses=4 type=i4]
  %tmp_i = icmp eq i4 %k_i, -8, !dbg !205         ; [#uses=1 type=i1] [debug line = 13:9@44:7@87:4]
  %k = add i4 %k_i, 1, !dbg !206                  ; [#uses=1 type=i4] [debug line = 13:61@44:7@87:4]
  br i1 %tmp_i, label %.preheader1.i.loopexit, label %2, !dbg !205 ; [debug line = 13:9@44:7@87:4]

; <label>:2                                       ; preds = %1
  %k_cast1_i = zext i4 %k_i to i32, !dbg !205     ; [#uses=8 type=i32] [debug line = 13:9@44:7@87:4]
  %k_cast1_i_cast = zext i4 %k_i to i8, !dbg !207 ; [#uses=1 type=i8] [debug line = 19:7@44:7@87:4]
  %tmp_6 = add i8 %tmp_18_cast, %k_cast1_i_cast, !dbg !207 ; [#uses=1 type=i8] [debug line = 19:7@44:7@87:4]
  %tmp_19_cast = zext i8 %tmp_6 to i32, !dbg !207 ; [#uses=1 type=i32] [debug line = 19:7@44:7@87:4]
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_19_cast, !dbg !207 ; [#uses=1 type=i16*] [debug line = 19:7@44:7@87:4]
  %empty_18 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind, !dbg !208 ; [debug line = 13:67@44:7@87:4]
  %tmp_5_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind, !dbg !208 ; [#uses=1 type=i32] [debug line = 13:67@44:7@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !209 ; [debug line = 14:1@44:7@87:4]
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i14*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_0_lo = load i14* %dct_coeff_table_0_ad, align 2, !dbg !210 ; [#uses=1 type=i14] [debug line = 16:48@44:7@87:4]
  %coeff_cast_i = zext i14 %dct_coeff_table_0_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_0_load = load i16* %col_inbuf_0_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_cast_i = sext i16 %col_inbuf_0_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_1_lo = load i15* %dct_coeff_table_1_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_1_cast_i = sext i15 %dct_coeff_table_1_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_1_load = load i16* %col_inbuf_1_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_1_cast_i = sext i16 %col_inbuf_1_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_2_lo = load i15* %dct_coeff_table_2_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_2_cast_i = sext i15 %dct_coeff_table_2_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_2_load = load i16* %col_inbuf_2_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_2_cast_i = sext i16 %col_inbuf_2_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_3_lo = load i15* %dct_coeff_table_3_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_3_cast_i = sext i15 %dct_coeff_table_3_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_3_load = load i16* %col_inbuf_3_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_3_cast_i = sext i16 %col_inbuf_3_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_4_lo = load i15* %dct_coeff_table_4_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_4_cast_i = sext i15 %dct_coeff_table_4_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_4_load = load i16* %col_inbuf_4_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_4_cast_i = sext i16 %col_inbuf_4_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_5_lo = load i15* %dct_coeff_table_5_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_5_cast_i = sext i15 %dct_coeff_table_5_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_5_load = load i16* %col_inbuf_5_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_5_cast_i = sext i16 %col_inbuf_5_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_6_lo = load i15* %dct_coeff_table_6_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_6_cast_i = sext i15 %dct_coeff_table_6_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_6_load = load i16* %col_inbuf_6_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_6_cast_i = sext i16 %col_inbuf_6_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_6_i = mul i29 %coeff_6_cast_i, %tmp_2_6_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_cast1_i, !dbg !210 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table_7_lo = load i15* %dct_coeff_table_7_ad, align 2, !dbg !210 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff_7_cast_i = sext i15 %dct_coeff_table_7_lo to i29 ; [#uses=1 type=i29]
  %col_inbuf_7_load = load i16* %col_inbuf_7_addr, align 2 ; [#uses=1 type=i16]
  %tmp_2_7_cast_i = sext i16 %col_inbuf_7_load to i29, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp_3_7_i = mul i29 %coeff_7_cast_i, %tmp_2_7_cast_i, !dbg !211 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp1 = add i29 %tmp_3_1_i, %tmp_3_i, !dbg !207 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp2 = add i29 %tmp_3_3_i, %tmp_3_2_i, !dbg !207 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp = add i29 %tmp1, %tmp2, !dbg !207          ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp4 = add i29 %tmp_3_5_i, %tmp_3_4_i, !dbg !207 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp6 = add i29 %tmp_3_7_i, 4096, !dbg !207     ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp5 = add i29 %tmp_3_6_i, %tmp6, !dbg !207    ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp3 = add i29 %tmp4, %tmp5, !dbg !207         ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp_9_i = add i29 %tmp, %tmp3, !dbg !207       ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp_1_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_9_i, i32 13, i32 28), !dbg !207 ; [#uses=1 type=i16] [debug line = 19:7@44:7@87:4]
  store i16 %tmp_1_i, i16* %col_outbuf_i_addr, align 2, !dbg !207 ; [debug line = 19:7@44:7@87:4]
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_5_i) nounwind, !dbg !212 ; [#uses=0 type=i32] [debug line = 20:4@44:7@87:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !213) nounwind, !dbg !206 ; [debug line = 13:61@44:7@87:4] [debug variable = k]
  br label %1, !dbg !206                          ; [debug line = 13:61@44:7@87:4]
}
...
!150 = metadata !{i32 37, i32 9, metadata !144, metadata !120}
!151 = metadata !{i32 40, i32 1, metadata !152, metadata !120}
!152 = metadata !{i32 786443, metadata !148, i32 40, i32 1, metadata !21, i32 11} ; [ DW_TAG_lexical_block ]
!153 = metadata !{i32 40, i32 2, metadata !152, metadata !120}
!154 = metadata !{i32 41, i32 1, metadata !152, metadata !120}
!155 = metadata !{i32 40, i32 34, metadata !152, metadata !120}
!156 = metadata !{i32 39, i32 63, metadata !148, metadata !120}
!157 = metadata !{i32 786688, metadata !110, metadata !"i", metadata !21, i32 28, metadata !146, i32 0, metadata !120} ; [ DW_TAG_auto_variable ]
!158 = metadata !{i32 48, i32 61, metadata !159, metadata !120}
!159 = metadata !{i32 786443, metadata !110, i32 48, i32 4, metadata !21, i32 14} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 50, i32 11, metadata !161, metadata !120}
!161 = metadata !{i32 786443, metadata !162, i32 50, i32 7, metadata !21, i32 16} ; [ DW_TAG_lexical_block ]
!162 = metadata !{i32 786443, metadata !159, i32 49, i32 1, metadata !21, i32 15} ; [ DW_TAG_lexical_block ]
!163 = metadata !{i32 48, i32 9, metadata !159, metadata !120}
!164 = metadata !{i32 51, i32 1, metadata !165, metadata !120}
!165 = metadata !{i32 786443, metadata !161, i32 51, i32 1, metadata !21, i32 17} ; [ DW_TAG_lexical_block ]
!166 = metadata !{i32 51, i32 2, metadata !165, metadata !120}
!167 = metadata !{i32 52, i32 1, metadata !165, metadata !120}
!168 = metadata !{i32 51, i32 34, metadata !165, metadata !120}
!169 = metadata !{i32 50, i32 63, metadata !161, metadata !120}
!170 = metadata !{i32 32, i32 8, metadata !171, metadata !120}
!171 = metadata !{i32 786443, metadata !110, i32 32, i32 4, metadata !21, i32 6} ; [ DW_TAG_lexical_block ]
!172 = metadata !{i32 32, i32 60, metadata !171, metadata !120}
!173 = metadata !{i32 32, i32 66, metadata !174, metadata !120}
!174 = metadata !{i32 786443, metadata !171, i32 32, i32 65, metadata !21, i32 7} ; [ DW_TAG_lexical_block ]
!175 = metadata !{i32 4, i32 81, metadata !176, metadata !180}
!176 = metadata !{i32 786478, i32 0, metadata !21, metadata !"dct_1d", metadata !"dct_1d", metadata !"", metadata !21, i32 4, metadata !177, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !30, i32 5} ; [ DW_TAG_subprogram ]
...
!178 = metadata !{null, metadata !179, metadata !179}
!179 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !116} ; [ DW_TAG_pointer_type ]
!180 = metadata !{i32 33, i32 7, metadata !174, metadata !120}
!181 = metadata !{i32 786689, metadata !176, metadata !"dst", null, i32 4, metadata !182, i32 0, metadata !180} ; [ DW_TAG_arg_variable ]
!182 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !116, metadata !27, i32 0, i32 0} ; [ DW_TAG_array_type ]
!183 = metadata !{i32 13, i32 9, metadata !184, metadata !180}
!184 = metadata !{i32 786443, metadata !185, i32 13, i32 4, metadata !21, i32 1} ; [ DW_TAG_lexical_block ]
!185 = metadata !{i32 786443, metadata !176, i32 5, i32 1, metadata !21, i32 0} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 13, i32 61, metadata !184, metadata !180}
!187 = metadata !{i32 19, i32 7, metadata !188, metadata !180}
!188 = metadata !{i32 786443, metadata !184, i32 13, i32 66, metadata !21, i32 2} ; [ DW_TAG_lexical_block ]
!189 = metadata !{i32 13, i32 67, metadata !188, metadata !180}
!190 = metadata !{i32 14, i32 1, metadata !188, metadata !180}
!191 = metadata !{i32 16, i32 48, metadata !192, metadata !180}
!192 = metadata !{i32 786443, metadata !193, i32 15, i32 77, metadata !21, i32 4} ; [ DW_TAG_lexical_block ]
!193 = metadata !{i32 786443, metadata !188, i32 15, i32 7, metadata !21, i32 3} ; [ DW_TAG_lexical_block ]
!194 = metadata !{i32 17, i32 10, metadata !192, metadata !180}
!195 = metadata !{i32 20, i32 4, metadata !188, metadata !180}
!196 = metadata !{i32 786688, metadata !185, metadata !"k", metadata !21, i32 6, metadata !146, i32 0, metadata !180} ; [ DW_TAG_auto_variable ]
!197 = metadata !{i32 43, i32 9, metadata !198, metadata !120}
!198 = metadata !{i32 786443, metadata !110, i32 43, i32 4, metadata !21, i32 12} ; [ DW_TAG_lexical_block ]
!199 = metadata !{i32 43, i32 61, metadata !198, metadata !120}
!200 = metadata !{i32 43, i32 67, metadata !201, metadata !120}
!201 = metadata !{i32 786443, metadata !198, i32 43, i32 66, metadata !21, i32 13} ; [ DW_TAG_lexical_block ]
!202 = metadata !{i32 4, i32 81, metadata !176, metadata !203}
!203 = metadata !{i32 44, i32 7, metadata !201, metadata !120}
!204 = metadata !{i32 786689, metadata !176, metadata !"dst", null, i32 4, metadata !182, i32 0, metadata !203} ; [ DW_TAG_arg_variable ]
!205 = metadata !{i32 13, i32 9, metadata !184, metadata !203}
!206 = metadata !{i32 13, i32 61, metadata !184, metadata !203}
!207 = metadata !{i32 19, i32 7, metadata !188, metadata !203}
!208 = metadata !{i32 13, i32 67, metadata !188, metadata !203}
!209 = metadata !{i32 14, i32 1, metadata !188, metadata !203}
!210 = metadata !{i32 16, i32 48, metadata !192, metadata !203}
!211 = metadata !{i32 17, i32 10, metadata !192, metadata !203}
!212 = metadata !{i32 20, i32 4, metadata !188, metadata !203}
!213 = metadata !{i32 786688, metadata !185, metadata !"k", metadata !21, i32 6, metadata !146, i32 0, metadata !203} ; [ DW_TAG_auto_variable ]
