; ModuleID = 'C:/Users/guill/Desktop/hls_lab3/dct.prj/solution6/.autopilot/db/a.g.1.bc'
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %in_block.assign, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !147 ; [debug line = 82:1]
  ...
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 0, !dbg !160 ; [#uses=1 type=[8 x i16]*] [debug line = 28:1@87:4]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %col_inbuf.addr, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !160 ; [debug line = 28:1@87:4]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !165 ; [debug line = 32:66@87:4]
  %rbegin3.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !165 ; [#uses=1 type=i32] [debug line = 32:66@87:4]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 %i.0.i, i32 0, !dbg !167 ; [#uses=1 type=i16*] [debug line = 33:7@87:4]
  %row_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.0.i, i32 0, !dbg !167 ; [#uses=1 type=i16*] [debug line = 33:7@87:4]
  call fastcc void @dct_1d(i16* %buf_2d_in.addr, i16* %row_outbuf.i.addr) nounwind, !dbg !167 ; [debug line = 33:7@87:4]
  %rend4.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i32 %rbegin3.i) nounwind, !dbg !168 ; [#uses=0 type=i32] [debug line = 34:4@87:4]
...
.preheader2.i:                                    ; preds = %6, %.preheader2.i.preheader
  ...
  %tmp.18 = icmp eq i32 %j.0.i, 8, !dbg !163      ; [#uses=1 type=i1] [debug line = 37:9@87:4]
  br i1 %tmp.18, label %.preheader1.i.preheader, label %3, !dbg !163 ; [debug line = 37:9@87:4]

.preheader1.i.preheader:                          ; preds = %.preheader2.i
  br label %.preheader1.i, !dbg !171              ; [debug line = 43:9@87:4]

; <label>:3                                       ; preds = %.preheader2.i
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !173 ; [debug line = 38:1@87:4]
  %rbegin11.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !173 ; [#uses=1 type=i32] [debug line = 38:1@87:4]
  br label %4, !dbg !175                          ; [debug line = 39:11@87:4]

; <label>:4                                       ; preds = %5, %3
  %i.1.i = phi i32 [ 0, %3 ], [ %i.2, %5 ]        ; [#uses=4 type=i32]
  %tmp.20 = icmp eq i32 %i.1.i, 8, !dbg !175      ; [#uses=1 type=i1] [debug line = 39:11@87:4]
  br i1 %tmp.20, label %6, label %5, !dbg !175    ; [debug line = 39:11@87:4]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !177 ; [debug line = 40:2@87:4]
  %rbegin9.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !177 ; [#uses=1 type=i32] [debug line = 40:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !179 ; [debug line = 41:1@87:4]
  %row_outbuf.i.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.1.i, i32 %j.0.i, !dbg !180 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %row_outbuf.i.load = load i16* %row_outbuf.i.addr.1, align 2, !dbg !180 ; [#uses=2 type=i16] [debug line = 40:1@87:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %row_outbuf.i.load) nounwind
  %col_inbuf.addr.2 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %j.0.i, i32 %i.1.i, !dbg !180 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  store i16 %row_outbuf.i.load, i16* %col_inbuf.addr.2, align 2, !dbg !180 ; [debug line = 40:1@87:4]
  %rend10.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0), i32 %rbegin9.i) nounwind, !dbg !181 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
...
; <label>:6                                       ; preds = %4
  %rend12.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0), i32 %rbegin11.i) nounwind, !dbg !183 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
...
.preheader1.i:                                    ; preds = %7, %.preheader1.i.preheader
  ...
  %tmp.19 = icmp eq i32 %i.2.i, 8, !dbg !171      ; [#uses=1 type=i1] [debug line = 43:9@87:4]
  br i1 %tmp.19, label %.preheader.i.preheader, label %7, !dbg !171 ; [debug line = 43:9@87:4]

.preheader.i.preheader:                           ; preds = %.preheader1.i
  br label %.preheader.i, !dbg !186               ; [debug line = 48:9@87:4]

; <label>:7                                       ; preds = %.preheader1.i
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !188 ; [debug line = 43:67@87:4]
  %rbegin.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !188 ; [#uses=1 type=i32] [debug line = 43:67@87:4]
  %col_inbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %i.2.i, i32 0, !dbg !190 ; [#uses=1 type=i16*] [debug line = 44:7@87:4]
  %col_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.2.i, i32 0, !dbg !190 ; [#uses=1 type=i16*] [debug line = 44:7@87:4]
  call fastcc void @dct_1d(i16* %col_inbuf.addr.1, i16* %col_outbuf.i.addr) nounwind, !dbg !190 ; [debug line = 44:7@87:4]
  %rend.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0), i32 %rbegin.i) nounwind, !dbg !191 ; [#uses=0 type=i32] [debug line = 45:4@87:4]
...
.preheader.i:                                     ; preds = %11, %.preheader.i.preheader
  ...
  %tmp.24 = icmp eq i32 %j.1.i, 8, !dbg !186      ; [#uses=1 type=i1] [debug line = 48:9@87:4]
  br i1 %tmp.24, label %dct_2d.exit, label %8, !dbg !186 ; [debug line = 48:9@87:4]

; <label>:8                                       ; preds = %.preheader.i
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !193 ; [debug line = 49:1@87:4]
  %rbegin7.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !193 ; [#uses=1 type=i32] [debug line = 49:1@87:4]
  br label %9, !dbg !195                          ; [debug line = 50:11@87:4]

; <label>:9                                       ; preds = %10, %8
  %i.3.i = phi i32 [ 0, %8 ], [ %i.3, %10 ]       ; [#uses=4 type=i32]
  %tmp.25 = icmp eq i32 %i.3.i, 8, !dbg !195      ; [#uses=1 type=i1] [debug line = 50:11@87:4]
  br i1 %tmp.25, label %11, label %10, !dbg !195  ; [debug line = 50:11@87:4]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !197 ; [debug line = 51:2@87:4]
  %rbegin5.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !197 ; [#uses=1 type=i32] [debug line = 51:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !199 ; [debug line = 52:1@87:4]
  %col_outbuf.i.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.3.i, i32 %j.1.i, !dbg !200 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  %col_outbuf.i.load = load i16* %col_outbuf.i.addr.1, align 2, !dbg !200 ; [#uses=2 type=i16] [debug line = 51:1@87:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %col_outbuf.i.load) nounwind
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 %j.1.i, i32 %i.3.i, !dbg !200 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  store i16 %col_outbuf.i.load, i16* %buf_2d_out.addr, align 2, !dbg !200 ; [debug line = 51:1@87:4]
  %rend6.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0), i32 %rbegin5.i) nounwind, !dbg !201 ; [#uses=0 type=i32] [debug line = 51:34@87:4]
...
; <label>:11                                      ; preds = %9
  %rend8.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0), i32 %rbegin7.i) nounwind, !dbg !203 ; [#uses=0 type=i32] [debug line = 51:34@87:4]
...
!175 = metadata !{i32 39, i32 11, metadata !176, metadata !151}
!176 = metadata !{i32 786443, metadata !174, i32 39, i32 7, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!177 = metadata !{i32 40, i32 2, metadata !178, metadata !151}
!178 = metadata !{i32 786443, metadata !176, i32 40, i32 1, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!179 = metadata !{i32 41, i32 1, metadata !178, metadata !151}
!180 = metadata !{i32 40, i32 1, metadata !178, metadata !151}
!181 = metadata !{i32 40, i32 34, metadata !178, metadata !151}
!182 = metadata !{i32 39, i32 63, metadata !176, metadata !151}
!183 = metadata !{i32 40, i32 34, metadata !176, metadata !151}
...
!195 = metadata !{i32 50, i32 11, metadata !196, metadata !151}
!196 = metadata !{i32 786443, metadata !194, i32 50, i32 7, metadata !6, i32 16} ; [ DW_TAG_lexical_block ]
!197 = metadata !{i32 51, i32 2, metadata !198, metadata !151}
!198 = metadata !{i32 786443, metadata !196, i32 51, i32 1, metadata !6, i32 17} ; [ DW_TAG_lexical_block ]
!199 = metadata !{i32 52, i32 1, metadata !198, metadata !151}
!200 = metadata !{i32 51, i32 1, metadata !198, metadata !151}
!201 = metadata !{i32 51, i32 34, metadata !198, metadata !151}
!202 = metadata !{i32 50, i32 63, metadata !196, metadata !151}
!203 = metadata !{i32 51, i32 34, metadata !196, metadata !151}
