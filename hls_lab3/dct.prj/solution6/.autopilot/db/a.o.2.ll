...
; <label>:3                                       ; preds = %1
  ...
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !67 ; [#uses=1 type=i32] [debug line = 71:67]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !73 ; [#uses=1 type=i32] [debug line = 74:2]
  ...
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.2), !dbg !75 ; [#uses=0 type=i32] [debug line = 74:67]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.1), !dbg !79 ; [#uses=0 type=i32] [debug line = 75:4]
...
; <label>:1                                       ; preds = %9, %0
  ...
  %r.cast = zext i4 %r to i32, !dbg !96           ; [#uses=8 type=i32] [debug line = 59:9]
  %r.cast1 = zext i4 %r to i6, !dbg !96           ; [#uses=1 type=i6] [debug line = 59:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10), !dbg !99 ; [#uses=1 type=i32] [debug line = 59:67]
  %tmp = shl i6 %r.cast1, 3, !dbg !101            ; [#uses=1 type=i6] [debug line = 62:1]
  %"buf[0].addr" = getelementptr [8 x i16]* %"buf[0]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[1].addr" = getelementptr [8 x i16]* %"buf[1]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[2].addr" = getelementptr [8 x i16]* %"buf[2]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[3].addr" = getelementptr [8 x i16]* %"buf[3]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[4].addr" = getelementptr [8 x i16]* %"buf[4]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[5].addr" = getelementptr [8 x i16]* %"buf[5]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[6].addr" = getelementptr [8 x i16]* %"buf[6]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
  %"buf[7].addr" = getelementptr [8 x i16]* %"buf[7]", i32 0, i32 %r.cast, !dbg !101 ; [#uses=1 type=i16*] [debug line = 62:1]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !105 ; [#uses=1 type=i32] [debug line = 62:2]
...
; <label>:7                                       ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.4), !dbg !107 ; [#uses=0 type=i32] [debug line = 62:66]
...
; <label>:9                                       ; preds = %4
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.3), !dbg !110 ; [#uses=0 type=i32] [debug line = 63:4]
...
.preheader2.i:                                    ; preds = %1, %newFuncRoot
  ...
  %j.0.i.cast = zext i4 %j.0.i to i32, !dbg !159  ; [#uses=9 type=i32] [debug line = 37:9@87:4]
  %tmp. = icmp eq i4 %j.0.i, -8, !dbg !159        ; [#uses=1 type=i1] [debug line = 37:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp., label %.preheader1.i.exitStub, label %5, !dbg !159 ; [debug line = 37:9@87:4]

; <label>:1                                       ; preds = %3
  %2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.1) nounwind, !dbg !161 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
...
; <label>:3                                       ; preds = %6, %5
  ...
  %i.1.i.cast = zext i4 %i.1.i to i32, !dbg !167  ; [#uses=1 type=i32] [debug line = 39:11@87:4]
...
; <label>:5                                       ; preds = %.preheader2.i
  ...
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5) nounwind, !dbg !168 ; [#uses=1 type=i32] [debug line = 38:1@87:4]
  %"col_inbuf[0].addr" = getelementptr [8 x i16]* %"col_inbuf[0]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[1].addr" = getelementptr [8 x i16]* %"col_inbuf[1]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[2].addr" = getelementptr [8 x i16]* %"col_inbuf[2]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[3].addr" = getelementptr [8 x i16]* %"col_inbuf[3]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[4].addr" = getelementptr [8 x i16]* %"col_inbuf[4]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[5].addr" = getelementptr [8 x i16]* %"col_inbuf[5]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[6].addr" = getelementptr [8 x i16]* %"col_inbuf[6]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  %"col_inbuf[7].addr" = getelementptr [8 x i16]* %"col_inbuf[7]", i32 0, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
...
; <label>:8                                       ; preds = %3
  ...
  %row_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.1.i.cast, i32 %j.0.i.cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
...
.preheader.i:                                     ; preds = %1, %newFuncRoot
  ...
  %j.1.i.cast = zext i4 %j.1.i to i32, !dbg !176  ; [#uses=2 type=i32] [debug line = 48:9@87:4]
  %tmp.7 = icmp eq i4 %j.1.i, -8, !dbg !176       ; [#uses=1 type=i1] [debug line = 48:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.7, label %dct_2d.exit.exitStub, label %5, !dbg !176 ; [debug line = 48:9@87:4]
...
; <label>:3                                       ; preds = %6, %5
  ...
  %i.3.i.cast = zext i4 %i.3.i to i32, !dbg !182  ; [#uses=2 type=i32] [debug line = 50:11@87:4]
  %tmp.8 = icmp eq i4 %i.3.i, -8, !dbg !182       ; [#uses=1 type=i1] [debug line = 50:11@87:4]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.8, label %1, label %6, !dbg !182     ; [debug line = 50:11@87:4]
...
; <label>:6                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str9) nounwind, !dbg !184 ; [debug line = 51:2@87:4]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str9) nounwind, !dbg !184 ; [#uses=1 type=i32] [debug line = 51:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !186 ; [debug line = 52:1@87:4]
  %col_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.3.i.cast, i32 %j.1.i.cast, !dbg !187 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  %col_outbuf.i.load = load i16* %col_outbuf.i.addr, align 2, !dbg !187 ; [#uses=1 type=i16] [debug line = 51:1@87:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 %j.1.i.cast, i32 %i.3.i.cast, !dbg !187 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  store i16 %col_outbuf.i.load, i16* %buf_2d_out.addr, align 2, !dbg !187 ; [debug line = 51:1@87:4]
...
; <label>:2                                       ; preds = %0
  ...
  %i.2.i.cast.i = zext i4 %i.0.i to i32           ; [#uses=8 type=i32]
...
; <label>:3                                       ; preds = %5, %2
  ...
  %k.cast1.i = zext i4 %k.i to i32, !dbg !199     ; [#uses=9 type=i32] [debug line = 13:9@33:7@87:4]
...
; <label>:5                                       ; preds = %3
  ...
  %tmp.5.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !202 ; [#uses=1 type=i32] [debug line = 13:67@33:7@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !204 ; [debug line = 14:1@33:7@87:4]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i14*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[0].addr" = getelementptr [8 x i16]* %"buf_2d_in[0]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[0].load" = load i16* %"buf_2d_in[0].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.cast.i = sext i16 %"buf_2d_in[0].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.i = mul i29 %coeff.cast.i, %tmp.2.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[1].addr" = getelementptr [8 x i16]* %"buf_2d_in[1]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[1].load" = load i16* %"buf_2d_in[1].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.1.cast.i = sext i16 %"buf_2d_in[1].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.1.i = mul i29 %coeff.1.cast.i, %tmp.2.1.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[2].addr" = getelementptr [8 x i16]* %"buf_2d_in[2]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[2].load" = load i16* %"buf_2d_in[2].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.2.cast.i = sext i16 %"buf_2d_in[2].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.2.i = mul i29 %coeff.2.cast.i, %tmp.2.2.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[3].addr" = getelementptr [8 x i16]* %"buf_2d_in[3]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[3].load" = load i16* %"buf_2d_in[3].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.3.cast.i = sext i16 %"buf_2d_in[3].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.3.i = mul i29 %coeff.3.cast.i, %tmp.2.3.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[4].addr" = getelementptr [8 x i16]* %"buf_2d_in[4]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[4].load" = load i16* %"buf_2d_in[4].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.4.cast.i = sext i16 %"buf_2d_in[4].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.4.i = mul i29 %coeff.4.cast.i, %tmp.2.4.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[5].addr" = getelementptr [8 x i16]* %"buf_2d_in[5]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[5].load" = load i16* %"buf_2d_in[5].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.5.cast.i = sext i16 %"buf_2d_in[5].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.5.i = mul i29 %coeff.5.cast.i, %tmp.2.5.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[6].addr" = getelementptr [8 x i16]* %"buf_2d_in[6]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[6].load" = load i16* %"buf_2d_in[6].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.6.cast.i = sext i16 %"buf_2d_in[6].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.6.i = mul i29 %coeff.6.cast.i, %tmp.2.6.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i32 0, i32 %k.cast1.i, !dbg !205 ; [#uses=1 type=i15*] [debug line = 16:48@33:7@87:4]
  ...
  %"buf_2d_in[7].addr" = getelementptr [8 x i16]* %"buf_2d_in[7]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[7].load" = load i16* %"buf_2d_in[7].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.7.cast.i = sext i16 %"buf_2d_in[7].load" to i29, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp.3.7.i = mul i29 %coeff.7.cast.i, %tmp.2.7.cast.i, !dbg !208 ; [#uses=1 type=i29] [debug line = 17:10@33:7@87:4]
  %tmp2 = add i29 %tmp.3.1.i, %tmp.3.i, !dbg !209 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp3 = add i29 %tmp.3.3.i, %tmp.3.2.i, !dbg !209 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !209         ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp5 = add i29 %tmp.3.5.i, %tmp.3.4.i, !dbg !209 ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp7 = add i29 %tmp.3.7.i, 4096, !dbg !209     ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp6 = add i29 %tmp.3.6.i, %tmp7, !dbg !209    ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !209         ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp.9.i = add i29 %tmp1, %tmp4, !dbg !209      ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp..i = lshr i29 %tmp.9.i, 13, !dbg !209      ; [#uses=1 type=i29] [debug line = 19:7@33:7@87:4]
  %tmp.1.i = trunc i29 %tmp..i to i16, !dbg !209  ; [#uses=1 type=i16] [debug line = 19:7@33:7@87:4]
  %row_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.2.i1.cast.i, i32 %k.cast1.i, !dbg !209 ; [#uses=1 type=i16*] [debug line = 19:7@33:7@87:4]
  store i16 %tmp.1.i, i16* %row_outbuf.i.addr, align 2, !dbg !209 ; [debug line = 19:7@33:7@87:4]
  %6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.5.i) nounwind, !dbg !210 ; [#uses=0 type=i32] [debug line = 20:4@33:7@87:4]
...
.preheader1.i:                                    ; preds = %dct_1d.exit, %newFuncRoot
  ...
  %tmp.5 = icmp eq i4 %i.2.i, -8, !dbg !214       ; [#uses=1 type=i1] [debug line = 43:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.5, label %.preheader.i.exitStub, label %1, !dbg !214 ; [debug line = 43:9@87:4]
...
; <label>:2                                       ; preds = %4, %1
  ...
  %k.cast1.i = zext i4 %k.i to i32, !dbg !221     ; [#uses=9 type=i32] [debug line = 13:9@44:7@87:4]
...
; <label>:4                                       ; preds = %2
  ...
  %tmp.5.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !222 ; [#uses=1 type=i32] [debug line = 13:67@44:7@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !223 ; [debug line = 14:1@44:7@87:4]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i14*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !224 ; [#uses=1 type=i14] [debug line = 16:48@44:7@87:4]
  %coeff.cast.i = zext i14 %dct_coeff_table.0.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[0].addr" = getelementptr [8 x i16]* %"col_inbuf[0]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[0].load" = load i16* %"col_inbuf[0].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.cast.i = sext i16 %"col_inbuf[0].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.i = mul i29 %coeff.cast.i, %tmp.2.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.1.cast.i = sext i15 %dct_coeff_table.1.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[1].addr" = getelementptr [8 x i16]* %"col_inbuf[1]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[1].load" = load i16* %"col_inbuf[1].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.1.cast.i = sext i16 %"col_inbuf[1].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.1.i = mul i29 %coeff.1.cast.i, %tmp.2.1.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.2.cast.i = sext i15 %dct_coeff_table.2.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[2].addr" = getelementptr [8 x i16]* %"col_inbuf[2]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[2].load" = load i16* %"col_inbuf[2].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.2.cast.i = sext i16 %"col_inbuf[2].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.2.i = mul i29 %coeff.2.cast.i, %tmp.2.2.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.3.cast.i = sext i15 %dct_coeff_table.3.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[3].addr" = getelementptr [8 x i16]* %"col_inbuf[3]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[3].load" = load i16* %"col_inbuf[3].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.3.cast.i = sext i16 %"col_inbuf[3].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.3.i = mul i29 %coeff.3.cast.i, %tmp.2.3.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.4.cast.i = sext i15 %dct_coeff_table.4.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[4].addr" = getelementptr [8 x i16]* %"col_inbuf[4]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[4].load" = load i16* %"col_inbuf[4].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.4.cast.i = sext i16 %"col_inbuf[4].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.4.i = mul i29 %coeff.4.cast.i, %tmp.2.4.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.5.cast.i = sext i15 %dct_coeff_table.5.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[5].addr" = getelementptr [8 x i16]* %"col_inbuf[5]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[5].load" = load i16* %"col_inbuf[5].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.5.cast.i = sext i16 %"col_inbuf[5].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.5.i = mul i29 %coeff.5.cast.i, %tmp.2.5.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.6.cast.i = sext i15 %dct_coeff_table.6.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[6].addr" = getelementptr [8 x i16]* %"col_inbuf[6]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[6].load" = load i16* %"col_inbuf[6].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.6.cast.i = sext i16 %"col_inbuf[6].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.6.i = mul i29 %coeff.6.cast.i, %tmp.2.6.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i32 0, i32 %k.cast1.i, !dbg !224 ; [#uses=1 type=i15*] [debug line = 16:48@44:7@87:4]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !224 ; [#uses=1 type=i15] [debug line = 16:48@44:7@87:4]
  %coeff.7.cast.i = sext i15 %dct_coeff_table.7.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[7].addr" = getelementptr [8 x i16]* %"col_inbuf[7]", i32 0, i32 %i.2.i.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[7].load" = load i16* %"col_inbuf[7].addr", align 2 ; [#uses=1 type=i16]
  %tmp.2.7.cast.i = sext i16 %"col_inbuf[7].load" to i29, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp.3.7.i = mul i29 %coeff.7.cast.i, %tmp.2.7.cast.i, !dbg !225 ; [#uses=1 type=i29] [debug line = 17:10@44:7@87:4]
  %tmp1 = add i29 %tmp.3.1.i, %tmp.3.i, !dbg !226 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp2 = add i29 %tmp.3.3.i, %tmp.3.2.i, !dbg !226 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp = add i29 %tmp1, %tmp2, !dbg !226          ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp4 = add i29 %tmp.3.5.i, %tmp.3.4.i, !dbg !226 ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp6 = add i29 %tmp.3.7.i, 4096, !dbg !226     ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp5 = add i29 %tmp.3.6.i, %tmp6, !dbg !226    ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp3 = add i29 %tmp4, %tmp5, !dbg !226         ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp.9.i = add i29 %tmp, %tmp3, !dbg !226       ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp..i = lshr i29 %tmp.9.i, 13, !dbg !226      ; [#uses=1 type=i29] [debug line = 19:7@44:7@87:4]
  %tmp.1.i = trunc i29 %tmp..i to i16, !dbg !226  ; [#uses=1 type=i16] [debug line = 19:7@44:7@87:4]
  %col_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.2.i1.cast.i, i32 %k.cast1.i, !dbg !226 ; [#uses=1 type=i16*] [debug line = 19:7@44:7@87:4]
  store i16 %tmp.1.i, i16* %col_outbuf.i.addr, align 2, !dbg !226 ; [debug line = 19:7@44:7@87:4]
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.5.i) nounwind, !dbg !227 ; [#uses=0 type=i32] [debug line = 20:4@44:7@87:4]
...
!19 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/Users/guill/Desktop/hls_lab3/dct.prj/solution6/.autopilot/db/dct.pragma.2.c", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab3", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !20, metadata !20, metadata !21, metadata !50} ; [ DW_TAG_compile_unit ]
!20 = metadata !{i32 0}
...
!23 = metadata !{i32 786473, metadata !"dct.c", metadata !"C:\5CUsers\5Cguill\5CDesktop\5Chls_lab3", null} ; [ DW_TAG_file_type ]
...
!184 = metadata !{i32 51, i32 2, metadata !185, metadata !136}
!185 = metadata !{i32 786443, metadata !179, i32 51, i32 1, metadata !23, i32 17} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 52, i32 1, metadata !185, metadata !136}
!187 = metadata !{i32 51, i32 1, metadata !185, metadata !136}
