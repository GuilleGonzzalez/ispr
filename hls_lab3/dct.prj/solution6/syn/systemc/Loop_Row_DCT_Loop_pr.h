...
struct Loop_Row_DCT_Loop_pr : public sc_module {
    ...
    dct_mul_mul_15s_1jbC<1,1,15,16,29>* dct_mul_mul_15s_1jbC_U9;
    dct_mul_mul_15s_1jbC<1,1,15,16,29>* dct_mul_mul_15s_1jbC_U10;
    dct_mul_mul_15s_1jbC<1,1,15,16,29>* dct_mul_mul_15s_1jbC_U11;
    dct_mac_muladd_14kbM<1,1,14,16,29,29>* dct_mac_muladd_14kbM_U12;
    dct_mac_muladd_15lbW<1,1,15,16,29,29>* dct_mac_muladd_15lbW_U13;
    ...
    dct_mac_muladd_15mb6<1,1,15,16,14,29>* dct_mac_muladd_15mb6_U16;
    ...
    sc_signal< sc_lv<1> > tmp_fu_294_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<4> > i_fu_300_p2;
    sc_signal< sc_lv<4> > i_reg_494;
    sc_signal< sc_lv<8> > tmp_15_cast_fu_326_p1;
    sc_signal< sc_lv<8> > tmp_15_cast_reg_499;
    sc_signal< sc_lv<3> > buf_2d_in_0_addr_reg_504;
    sc_signal< sc_lv<3> > buf_2d_in_1_addr_reg_509;
    sc_signal< sc_lv<3> > buf_2d_in_2_addr_reg_514;
    sc_signal< sc_lv<3> > buf_2d_in_3_addr_reg_519;
    sc_signal< sc_lv<3> > buf_2d_in_4_addr_reg_524;
    sc_signal< sc_lv<3> > buf_2d_in_5_addr_reg_529;
    sc_signal< sc_lv<3> > buf_2d_in_6_addr_reg_534;
    sc_signal< sc_lv<3> > buf_2d_in_7_addr_reg_539;
    ...
    sc_signal< sc_lv<8> > tmp_5_reg_562;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter1_tmp_5_reg_562;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter2_tmp_5_reg_562;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter3_tmp_5_reg_562;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter4_tmp_5_reg_562;
    sc_signal< sc_lv<15> > dct_coeff_table_1_lo_reg_587;
    sc_signal< sc_lv<16> > buf_2d_in_1_load_reg_592;
    sc_signal< sc_lv<15> > dct_coeff_table_3_lo_reg_602;
    sc_signal< sc_lv<16> > buf_2d_in_3_load_reg_607;
    sc_signal< sc_lv<15> > dct_coeff_table_5_lo_reg_617;
    sc_signal< sc_lv<16> > buf_2d_in_5_load_reg_622;
    sc_signal< sc_lv<14> > dct_coeff_table_0_lo_reg_637;
    sc_signal< sc_lv<16> > buf_2d_in_0_load_reg_642;
    ...
    sc_signal< sc_lv<16> > buf_2d_in_2_load_reg_657;
    ...
    sc_signal< sc_lv<16> > buf_2d_in_4_load_reg_672;
    ...
    sc_signal< sc_lv<16> > buf_2d_in_6_load_reg_687;
    sc_signal< sc_lv<15> > dct_coeff_table_7_lo_reg_692;
    sc_signal< sc_lv<16> > buf_2d_in_7_load_reg_697;
    sc_signal< sc_lv<29> > tmp1_fu_406_p2;
    sc_signal< sc_lv<29> > tmp1_reg_702;
    sc_signal< sc_lv<29> > grp_fu_467_p3;
    sc_signal< sc_lv<29> > tmp5_reg_707;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter3;
    sc_signal< sc_lv<29> > grp_fu_474_p3;
    sc_signal< sc_lv<29> > tmp6_reg_712;
    ...
    void thread_tmp_15_cast_fu_326_p1();
