...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=515,HLS_SYN_TPT=122,HLS_SYN_MEM=6,HLS_SYN_DSP=16,HLS_SYN_FF=3414,HLS_SYN_LUT=1498}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == (Loop_Xpose_Row_Outer_U0_ap_done & Loop_Xpose_Row_Outer_U0_ap_continue))) begin
            ap_sync_reg_channel_write_col_inbuf_0 <= 1'b0;
        end else begin
...
assign Loop_Col_DCT_Loop_pr_U0_ap_start = (col_inbuf_0_t_empty_n & col_inbuf_1_t_empty_n & col_inbuf_2_t_empty_n & col_inbuf_3_t_empty_n & col_inbuf_4_t_empty_n & col_inbuf_5_t_empty_n & col_inbuf_6_t_empty_n & col_inbuf_7_t_empty_n);
...
assign ap_channel_done_col_inbuf_0 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_0 ^ 1'b1));

assign ap_channel_done_col_inbuf_1 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_1 ^ 1'b1));

assign ap_channel_done_col_inbuf_2 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_2 ^ 1'b1));

assign ap_channel_done_col_inbuf_3 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_3 ^ 1'b1));

assign ap_channel_done_col_inbuf_4 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_4 ^ 1'b1));

assign ap_channel_done_col_inbuf_5 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_5 ^ 1'b1));

assign ap_channel_done_col_inbuf_6 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_6 ^ 1'b1));

assign ap_channel_done_col_inbuf_7 = (Loop_Xpose_Row_Outer_U0_ap_done & (ap_sync_reg_channel_write_col_inbuf_7 ^ 1'b1));
