...
struct dct_1d2 : public sc_module {
    ...
    sc_signal< sc_lv<8> > tmp_18_cast_reg_582;
    sc_signal< sc_lv<6> > src_addr_reg_587;
    sc_signal< sc_lv<6> > src_addr_1_reg_592;
    sc_signal< sc_lv<6> > src_addr_2_reg_597;
    sc_signal< sc_lv<6> > src_addr_3_reg_602;
    sc_signal< sc_lv<6> > src_addr_4_reg_607;
    sc_signal< sc_lv<6> > src_addr_5_reg_612;
    sc_signal< sc_lv<6> > src_addr_6_reg_617;
    sc_signal< sc_lv<6> > src_addr_7_reg_622;
    sc_signal< sc_lv<1> > tmp_fu_416_p2;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_tmp_reg_627;
    sc_signal< sc_lv<4> > k_1_fu_422_p2;
    sc_signal< sc_lv<4> > k_1_reg_631;
    sc_signal< sc_lv<32> > k_cast8_fu_428_p1;
    sc_signal< sc_lv<32> > k_cast8_reg_636;
    sc_signal< sc_lv<8> > tmp_30_fu_438_p2;
    sc_signal< sc_lv<8> > tmp_30_reg_646;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter1_tmp_30_reg_646;
    sc_signal< sc_lv<15> > dct_coeff_table_1_lo_reg_666;
    sc_signal< sc_lv<15> > dct_coeff_table_3_lo_reg_671;
    sc_signal< sc_lv<14> > dct_coeff_table_0_lo_reg_681;
    sc_signal< sc_lv<29> > tmp_7_1_fu_526_p2;
    sc_signal< sc_lv<29> > tmp_7_1_reg_686;
    sc_signal< sc_lv<29> > tmp_7_3_fu_532_p2;
    sc_signal< sc_lv<29> > tmp_7_3_reg_696;
    sc_signal< sc_lv<15> > dct_coeff_table_5_lo_reg_706;
    sc_signal< sc_lv<15> > dct_coeff_table_2_lo_reg_721;
    sc_signal< sc_lv<15> > dct_coeff_table_4_lo_reg_726;
    sc_signal< sc_lv<29> > tmp_7_5_fu_545_p2;
    sc_signal< sc_lv<29> > tmp_7_5_reg_731;
    sc_signal< sc_lv<15> > dct_coeff_table_6_lo_reg_736;
    sc_signal< sc_lv<15> > dct_coeff_table_7_lo_reg_741;
    sc_signal< sc_lv<29> > grp_fu_538_p3;
    sc_signal< sc_lv<29> > tmp2_reg_746;
    sc_signal< sc_lv<29> > tmp1_fu_485_p2;
    sc_signal< sc_lv<29> > tmp1_reg_751;
    sc_signal< sc_lv<29> > grp_fu_559_p3;
    sc_signal< sc_lv<29> > tmp5_reg_756;
    sc_signal< sc_lv<29> > grp_fu_566_p3;
    sc_signal< sc_lv<29> > tmp6_reg_761;
    sc_signal< sc_lv<16> > tmp_5_reg_766;
    ...
    sc_signal< sc_lv<32> > tmp_35_cast_fu_522_p1;
    ...
    sc_signal< sc_lv<29> > tmp4_fu_503_p2;
    sc_signal< sc_lv<29> > tmp_3_fu_507_p2;
    ...
    void thread_tmp_35_cast_fu_522_p1();
