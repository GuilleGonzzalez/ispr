...
; <label>:1                                       ; preds = %0, %ifBlock
  ...
  %r = phi i4 [ 0, %0 ], [ %r_cast4_mid2_v, %ifBlock ]
...
.reset:                                           ; preds = %1
  ...
  %r_cast4_mid2_v = select i1 %exitcond, i4 %r_1, i4 %r
...
branch0:                                          ; preds = %.reset
  %buf_0_addr = getelementptr [8 x i16]* %buf_0, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_0_addr, align 2
  br label %ifBlock

branch1:                                          ; preds = %.reset
  %buf_1_addr = getelementptr [8 x i16]* %buf_1, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_1_addr, align 2
  br label %ifBlock

branch2:                                          ; preds = %.reset
  %buf_2_addr = getelementptr [8 x i16]* %buf_2, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_2_addr, align 2
  br label %ifBlock

branch3:                                          ; preds = %.reset
  %buf_3_addr = getelementptr [8 x i16]* %buf_3, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_3_addr, align 2
  br label %ifBlock

branch4:                                          ; preds = %.reset
  %buf_4_addr = getelementptr [8 x i16]* %buf_4, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_4_addr, align 2
  br label %ifBlock

branch5:                                          ; preds = %.reset
  %buf_5_addr = getelementptr [8 x i16]* %buf_5, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_5_addr, align 2
  br label %ifBlock

branch6:                                          ; preds = %.reset
  %buf_6_addr = getelementptr [8 x i16]* %buf_6, i32 0, i32 %r_cast4_mid2
  store i16 %input_load, i16* %buf_6_addr, align 2
  br label %ifBlock

branch7:                                          ; preds = %.reset
  %buf_7_addr = getelementptr [8 x i16]* %buf_7, i32 0, i32 %r_cast4_mid2
...
.preheader2.preheader:                            ; preds = %.preheader2.preheader.preheader, %ifBlock
  ...
  %j = phi i4 [ %j_cast5_mid2_v, %ifBlock ], [ 0, %.preheader2.preheader.preheader ]
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_7)
...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %j_cast5_mid2 = zext i4 %j_cast5_mid2_v to i32
  %j_cast5_mid2_cast = zext i4 %j_cast5_mid2_v to i8
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1_mid2, i3 0)
  %tmp_4_cast = zext i7 %tmp_1 to i8
  %tmp_5 = add i8 %tmp_4_cast, %j_cast5_mid2_cast
  %tmp_5_cast = zext i8 %tmp_5 to i32
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_5_cast
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_8 = add i8 %i_3_cast1_cast, %tmp_8_cast
  %tmp_10_cast = zext i8 %tmp_8 to i32
  %out_block_addr = getelementptr [64 x i16]* %out_block, i32 0, i32 %tmp_10_cast
  %tmp_10 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_mid2, i3 0)
  %tmp_12_cast = zext i7 %tmp_10 to i8
  %tmp_11 = add i8 %j_1_cast2_mid2_cast, %tmp_12_cast
  %tmp_13_cast = zext i8 %tmp_11 to i32
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i32 0, i32 %tmp_13_cast
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_3)
...
branch0:                                          ; preds = %.preheader2
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_0_addr, align 2
  br label %ifBlock

branch1:                                          ; preds = %.preheader2
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_1_addr, align 2
  br label %ifBlock

branch2:                                          ; preds = %.preheader2
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_2_addr, align 2
  br label %ifBlock

branch3:                                          ; preds = %.preheader2
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_3_addr, align 2
  br label %ifBlock

branch4:                                          ; preds = %.preheader2
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_4_addr, align 2
  br label %ifBlock

branch5:                                          ; preds = %.preheader2
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_5_addr, align 2
  br label %ifBlock

branch6:                                          ; preds = %.preheader2
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i32 0, i32 %j_cast5_mid2
  store i16 %row_outbuf_load, i16* %col_inbuf_6_addr, align 2
  br label %ifBlock

branch7:                                          ; preds = %.preheader2
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i32 0, i32 %j_cast5_mid2
...
define internal fastcc void @dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %i_2, [64 x i16]* nocapture %dst, i4 %i_21) {
  ...
  %tmp_15_cast = zext i7 %tmp_12 to i8
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_13 = add i8 %tmp_15_cast, %k_cast8_cast
  %tmp_16_cast = zext i8 %tmp_13 to i32
  %dst_addr = getelementptr [64 x i16]* %dst, i32 0, i32 %tmp_16_cast
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8)
  ...
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_s) nounwind
  br label %1
...
.reset:                                           ; preds = %1
  ...
  %tmp_17_cast = zext i7 %tmp to i8
  %tmp_3 = trunc i4 %r_i_cast4_mid2_v to i3
  ...
  %tmp_s = add i8 %tmp_17_cast, %c_i_cast1_cast
  %tmp_19_cast = zext i8 %tmp_s to i32
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_19_cast
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @p_str13) nounwind
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str13) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  ...
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_2_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
