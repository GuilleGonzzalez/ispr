...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=529,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=8,HLS_SYN_FF=2011,HLS_SYN_LUT=1845}" *)
...
reg   [0:0] exitcond_flatten_reg_310;
wire    ap_CS_fsm_pp0_stage0;
wire    ap_block_state5_pp0_stage0_iter0;
wire    ap_block_state6_pp0_stage0_iter1;
wire    ap_block_state7_pp0_stage0_iter2;
wire    ap_block_pp0_stage0_flag00011001;
reg   [0:0] ap_reg_pp0_iter1_exitcond_flatten_reg_310;
wire   [6:0] indvar_flatten_next_fu_222_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [3:0] c_i_mid2_fu_240_p3;
reg   [3:0] c_i_mid2_reg_319;
wire   [3:0] r_i_cast4_mid2_v_fu_248_p3;
reg   [3:0] r_i_cast4_mid2_v_reg_326;
wire   [2:0] tmp_3_fu_256_p1;
reg   [2:0] tmp_3_reg_332;
wire   [5:0] sum3_i_fu_295_p2;
reg   [5:0] sum3_i_reg_342;
...
reg   [3:0] c_i_phi_fu_158_p4;
reg    ap_reg_grp_dct_2d_fu_165_ap_start;
wire    ap_CS_fsm_state3;
reg    ap_reg_grp_read_data_fu_194_ap_start;
wire    ap_CS_fsm_state2;
wire   [31:0] tmp_19_cast_fu_290_p1;
wire   [31:0] sum3_i_cast_fu_306_p1;
wire   [0:0] exitcond_i3_fu_234_p2;
wire   [3:0] r_fu_228_p2;
wire   [6:0] tmp_fu_260_p3;
wire   [7:0] tmp_17_cast_fu_267_p1;
wire   [7:0] c_i_cast1_cast_fu_281_p1;
wire   [7:0] tmp_s_fu_284_p2;
wire   [5:0] tmp_i_mid2_fu_271_p3;
wire   [5:0] c_i_cast2_fu_278_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state5))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (grp_dct_2d_fu_165_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_reg_310 == 1'd0) & (1'b1 == ap_enable_reg_pp0_iter1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (exitcond_flatten_fu_216_p2 == 1'd0))) begin
        indvar_flatten_reg_132 <= indvar_flatten_next_fu_222_p2;
    end else if (((1'b1 == ap_CS_fsm_state4) & (grp_dct_2d_fu_165_ap_done == 1'b1))) begin
        indvar_flatten_reg_132 <= 7'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_fu_216_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_reg_310 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0))) begin
        buf_2d_out_address0 = tmp_19_cast_fu_290_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond_flatten_reg_310 == 1'd0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0))) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_reg_pp0_iter1_exitcond_flatten_reg_310 == 1'd0))) begin
        output_r_we0 = 1'b1;
    end else begin
        output_r_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (grp_read_data_fu_194_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_dct_2d_fu_165_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (exitcond_flatten_fu_216_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (exitcond_flatten_fu_216_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign c_fu_301_p2 = (4'd1 + c_i_mid2_reg_319);

assign c_i_cast1_cast_fu_281_p1 = c_i_mid2_reg_319;

assign c_i_cast2_fu_278_p1 = c_i_mid2_reg_319;

assign c_i_mid2_fu_240_p3 = ((exitcond_i3_fu_234_p2[0:0] === 1'b1) ? 4'd0 : c_i_phi_fu_158_p4);

assign exitcond_flatten_fu_216_p2 = ((indvar_flatten_reg_132 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond_i3_fu_234_p2 = ((c_i_phi_fu_158_p4 == 4'd8) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next_fu_222_p2 = (indvar_flatten_reg_132 + 7'd1);

assign input_r_address0 = grp_read_data_fu_194_input_r_address0;

assign input_r_ce0 = grp_read_data_fu_194_input_r_ce0;

assign output_r_address0 = sum3_i_cast_fu_306_p1;

assign output_r_d0 = buf_2d_out_q0;

assign r_fu_228_p2 = (4'd1 + r_i_phi_fu_147_p4);

assign r_i_cast4_mid2_v_fu_248_p3 = ((exitcond_i3_fu_234_p2[0:0] === 1'b1) ? r_fu_228_p2 : r_i_phi_fu_147_p4);

assign sum3_i_cast_fu_306_p1 = sum3_i_reg_342;

assign sum3_i_fu_295_p2 = (tmp_i_mid2_fu_271_p3 + c_i_cast2_fu_278_p1);

assign tmp_17_cast_fu_267_p1 = tmp_fu_260_p3;

assign tmp_19_cast_fu_290_p1 = tmp_s_fu_284_p2;

assign tmp_3_fu_256_p1 = r_i_cast4_mid2_v_fu_248_p3[2:0];

assign tmp_fu_260_p3 = {{r_i_cast4_mid2_v_reg_326}, {3'd0}};

assign tmp_i_mid2_fu_271_p3 = {{tmp_3_reg_332}, {3'd0}};

assign tmp_s_fu_284_p2 = (tmp_17_cast_fu_267_p1 + c_i_cast1_cast_fu_281_p1);
