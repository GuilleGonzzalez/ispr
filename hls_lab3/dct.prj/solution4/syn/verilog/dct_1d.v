...
reg   [3:0] k_reg_288;
wire   [7:0] tmp_15_cast_fu_307_p1;
reg   [7:0] tmp_15_cast_reg_483;
...
wire   [31:0] k_cast8_fu_335_p1;
reg   [31:0] k_cast8_reg_537;
...
wire   [31:0] tmp_16_cast_fu_422_p1;
wire   [6:0] tmp_12_fu_299_p3;
wire   [7:0] k_cast8_cast_fu_342_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (tmp_fu_323_p2 == 1'd0))) begin
        k_cast8_reg_537[3 : 0] <= k_cast8_fu_335_p1[3 : 0];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        tmp_15_cast_reg_483[6 : 3] <= tmp_15_cast_fu_307_p1[6 : 3];
    end
end
...
assign dct_coeff_table_0_address0 = k_cast8_reg_537;

assign dct_coeff_table_1_address0 = k_cast8_fu_335_p1;

assign dct_coeff_table_2_address0 = k_cast8_reg_537;

assign dct_coeff_table_3_address0 = k_cast8_fu_335_p1;

assign dct_coeff_table_4_address0 = k_cast8_reg_537;

assign dct_coeff_table_5_address0 = k_cast8_fu_335_p1;

assign dct_coeff_table_6_address0 = k_cast8_reg_537;

assign dct_coeff_table_7_address0 = k_cast8_reg_537;

assign dst_address0 = tmp_16_cast_fu_422_p1;

assign dst_d0 = tmp_5_reg_701;

assign grp_fu_444_p1 = grp_fu_444_p10;

assign grp_fu_444_p10 = dct_coeff_table_0_lo_reg_621;
...
assign k_cast8_cast_fu_342_p1 = k_reg_288;

assign k_cast8_fu_335_p1 = k_reg_288;
...
assign tmp_13_fu_346_p2 = (tmp_15_cast_reg_483 + k_cast8_cast_fu_342_p1);

assign tmp_15_cast_fu_307_p1 = tmp_12_fu_299_p3;

assign tmp_16_cast_fu_422_p1 = ap_reg_pp0_iter4_tmp_13_reg_546;
...
always @ (posedge ap_clk) begin
    tmp_15_cast_reg_483[2:0] <= 3'b000;
    tmp_15_cast_reg_483[7] <= 1'b0;
    k_cast8_reg_537[31:4] <= 28'b0000000000000000000000000000;
end
