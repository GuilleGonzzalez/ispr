; ModuleID = 'C:/Users/guill/Desktop/hls_lab3/dct.prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:4                                       ; preds = %5, %3
  ...
  %i_1_cast4_cast = zext i4 %i_1 to i8            ; [#uses=1 type=i8]
  %tmp_7 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1, i3 0) ; [#uses=1 type=i7]
  %tmp_10_cast = zext i7 %tmp_7 to i8, !dbg !57   ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_6 = add i8 %j_cast5_cast, %tmp_10_cast, !dbg !57 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_11_cast = zext i8 %tmp_6 to i32, !dbg !57  ; [#uses=1 type=i32] [debug line = 40:10]
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_11_cast, !dbg !57 ; [#uses=1 type=i16*] [debug line = 40:10]
  %tmp_10 = add i8 %i_1_cast4_cast, %tmp_6_cast, !dbg !57 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_12_cast = zext i8 %tmp_10 to i32, !dbg !57 ; [#uses=1 type=i32] [debug line = 40:10]
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i32 0, i32 %tmp_12_cast, !dbg !57 ; [#uses=1 type=i16*] [debug line = 40:10]
