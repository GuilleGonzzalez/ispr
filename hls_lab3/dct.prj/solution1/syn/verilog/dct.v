...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=3959,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=1,HLS_SYN_FF=875,HLS_SYN_LUT=816}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_167_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state6) & (1'd0 == exitcond1_i3_fu_243_p2))) begin
        c_i5_reg_136 <= 4'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_167_p2 == 1'd0))) begin
        c_i_reg_114 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (exitcond_i6_fu_285_p2 == 1'd1))) begin
        r_i2_reg_125 <= r_1_reg_350;
    end else if (((1'b1 == ap_CS_fsm_state5) & (grp_dct_2d_fu_147_ap_done == 1'b1))) begin
        r_i2_reg_125 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond_i_fu_209_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (1'd0 == exitcond_i6_fu_285_p2))) begin
        sum3_i_reg_373 <= sum3_i_fu_297_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (1'd0 == exitcond1_i3_fu_243_p2))) begin
        tmp_i4_reg_355[5 : 3] <= tmp_i4_fu_259_p3[5 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_167_p2 == 1'd0))) begin
        tmp_i_reg_319[5 : 3] <= tmp_i_fu_183_p3[5 : 3];
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (exitcond1_i3_fu_243_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (grp_dct_2d_fu_147_ap_done == 1'b1))) begin
...
assign c_1_fu_291_p2 = (c_i5_reg_136 + 4'd1);

assign c_fu_215_p2 = (c_i_reg_114 + 4'd1);
...
assign exitcond1_i3_fu_243_p2 = ((r_i2_reg_125 == 4'd8) ? 1'b1 : 1'b0);

assign exitcond1_i_fu_167_p2 = ((r_i_reg_103 == 4'd8) ? 1'b1 : 1'b0);

assign exitcond_i6_fu_285_p2 = ((c_i5_reg_136 == 4'd8) ? 1'b1 : 1'b0);

assign exitcond_i_fu_209_p2 = ((c_i_reg_114 == 4'd8) ? 1'b1 : 1'b0);
...
assign r_1_fu_249_p2 = (r_i2_reg_125 + 4'd1);

assign r_fu_173_p2 = (r_i_reg_103 + 4'd1);
...
assign tmp_fu_155_p3 = {{r_i_reg_103}, {3'd0}};

assign tmp_i4_fu_259_p3 = {{tmp_4_fu_255_p1}, {3'd0}};

assign tmp_i_fu_183_p3 = {{tmp_3_fu_179_p1}, {3'd0}};

assign tmp_s_fu_231_p3 = {{r_i2_reg_125}, {3'd0}};
