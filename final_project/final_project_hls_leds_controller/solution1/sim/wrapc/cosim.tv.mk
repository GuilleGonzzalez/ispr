...
$(ObjDir)/leds_controller_test.cpp_pre.cpp.tb.o : leds_controller_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling leds_controller_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/leds_controller.cpp_pre.cpp.tb.o : leds_controller.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling leds_controller.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
