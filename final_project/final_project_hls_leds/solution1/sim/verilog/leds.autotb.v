...
`define AUTOTB_DUT      leds
`define AUTOTB_DUT_INST AESL_inst_leds
`define AUTOTB_TOP      apatb_leds_top
`define AUTOTB_LAT_RESULT_FILE "leds.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "leds.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_leds_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_row_V 1
`define AESL_DEPTH_col_V 1
...
`define AUTOTB_TVIN_in_V_V_out_wrapc  "../tv/rtldatafile/rtl.leds.autotvin_in_V_V.dat"
...
`define AUTOTB_TVOUT_row_V_out_wrapc  "../tv/rtldatafile/rtl.leds.autotvout_row_V.dat"
`define AUTOTB_TVOUT_col_V_out_wrapc  "../tv/rtldatafile/rtl.leds.autotvout_col_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 16;
parameter LENGTH_row_V = 1;
parameter LENGTH_col_V = 1;
parameter LENGTH_in_V_V = 1;
...
// The signal of port row_V
reg [6: 0] AESL_REG_row_V = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
        AESL_REG_row_V = 0; 
    else
        AESL_REG_row_V <= row_V;
end 

initial begin : write_file_process_row_V
    integer fp;
    integer fp_size;
    integer err;
    integer ret;
    ...
    reg [8 * 5:1] str;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVOUT_row_V_out_wrapc,"w");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_row_V_out_wrapc);
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        $fdisplay(fp,"[[transaction]] %d", transaction_idx);
          $fdisplay(fp,"0x%x", AESL_REG_row_V);
...
// The signal of port col_V
reg [9: 0] AESL_REG_col_V = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
        AESL_REG_col_V = 0; 
    else
        AESL_REG_col_V <= col_V;
end 

initial begin : write_file_process_col_V
    integer fp;
    integer fp_size;
    integer err;
    integer ret;
    ...
    reg [8 * 5:1] str;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVOUT_col_V_out_wrapc,"w");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_col_V_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        # 0.4;
        $fdisplay(fp,"[[transaction]] %d", transaction_idx);
          $fdisplay(fp,"0x%x", AESL_REG_col_V);
    transaction_idx = transaction_idx + 1;
      $fdisplay(fp,"[[/transaction]]");
    end
    $fdisplay(fp,"[[[/runtime]]]");
...
reg end_row_V;
reg [31:0] size_row_V;
reg [31:0] size_row_V_backup;
reg end_col_V;
reg [31:0] size_col_V;
reg [31:0] size_col_V_backup;
