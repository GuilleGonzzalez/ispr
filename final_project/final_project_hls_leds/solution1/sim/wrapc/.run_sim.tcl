...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "leds.autotvin.dat"
	set constFileTvOut       "leds.autotvout.dat"
	set constFileHdlTvIn     "leds.autohdltvin.dat"
	set constFileHdlTvOut    "leds.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
