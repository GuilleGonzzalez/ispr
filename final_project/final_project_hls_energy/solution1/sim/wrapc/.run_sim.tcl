...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "energy.autotvin.dat"
	set constFileTvOut       "energy.autotvout.dat"
	set constFileHdlTvIn     "energy.autohdltvin.dat"
	set constFileHdlTvOut    "energy.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
