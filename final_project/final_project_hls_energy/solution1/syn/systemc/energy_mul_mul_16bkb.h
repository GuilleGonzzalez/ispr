...
#ifndef __energy_mul_mul_16bkb__HH__
#define __energy_mul_mul_16bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(energy_mul_mul_16bkb) {
    ...
    SC_CTOR(energy_mul_mul_16bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
