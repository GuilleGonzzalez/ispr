; ModuleID = 'C:/Users/guill/Desktop/final_project_hls_energy/solution1/.autopilot/db/a.g.1.bc'
...
define void @energy(i16* %y, i16 signext %x) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{i16* %y}, i64 0, metadata !21), !dbg !22 ; [debug line = 3:21] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i16 %x}, i64 0, metadata !23), !dbg !24 ; [debug line = 3:31] [debug variable = x]
  call void (...)* @_ssdm_op_SpecInterface(i16* %y, i8* getelementptr inbounds ([7 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !25 ; [debug line = 5:1]
  %tmp = sext i16 %x to i32, !dbg !25             ; [#uses=1 type=i32] [debug line = 5:1]
  ...
  %tmp.1 = mul i16 %x, %x, !dbg !27               ; [#uses=1 type=i16] [debug line = 5:3]
  store i16 %tmp.1, i16* %y, align 2, !dbg !27    ; [debug line = 5:3]
