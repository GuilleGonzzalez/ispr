...
`define AUTOTB_DUT      energy
`define AUTOTB_DUT_INST AESL_inst_energy
`define AUTOTB_TOP      apatb_energy_top
`define AUTOTB_LAT_RESULT_FILE "energy.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "energy.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_energy_top
...
`define AUTOTB_TVIN_x  "./c.energy.autotvin_x.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.energy.autotvin_x.dat"
`define AUTOTB_TVOUT_y  "./c.energy.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "./impl_rtl.energy.autotvout_y.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.energy.autotvout_y.dat", "r");
    fp2 = $fopen("./impl_rtl.energy.autotvout_y.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.energy.autotvout_y.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.energy.autotvout_y.dat\"!");
    else begin
        $display("Comparing rtl.energy.autotvout_y.dat with impl_rtl.energy.autotvout_y.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
